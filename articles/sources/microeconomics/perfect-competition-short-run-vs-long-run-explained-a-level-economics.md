...
::: econos-diagram svgKey="firmLevelPcVsMonopoly" state="base" label="The competitive firm's cost and revenue curves" caption="The competitive firm's cost and revenue curves: a horizontal AR = MR = P (price taker) with U-shaped MC and AC, and profit-maximising output where MC = MR."
:::
