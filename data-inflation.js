...
window.ECONOS_TOPIC = {
  ...
  cards: [
    ...
    /* ----- CARD 7 — Deflation ----- */
    {
      ...
      bridge: {
        title: 'Where to next',
        text: "You've got the conceptual model. Now apply it: try the <strong>AD/AS simulator</strong> in <em>Land it</em> to see demand-pull, cost-push, and supply shocks play out interactively."
      }
    }
  ]
};
