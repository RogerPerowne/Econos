...
(function () {
  ...
  function costCurves(opts) {
    ...
    var spec = {
      width: opts.width || 562,
      height: opts.height || 433,
      chartArea: opts.chartArea || { x: 45, y: 20, width: 490, height: 370 },
  ...
  function monopolyProfitMax(opts) {
    ...
    return {
      width: opts.width || 577, height: opts.height || 444,
      chartArea: opts.chartArea || { x: 45, y: 20, width: 505, height: 382 },
  ...
  function totalCost(opts) {
    ...
    return {
      width: opts.width || 562,
      height: opts.height || 433,
      chartArea: opts.chartArea || { x: 44, y: 19, width: 493, height: 370 },
