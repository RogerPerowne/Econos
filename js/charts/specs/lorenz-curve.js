...
(function () {
  ...
  window.ECONOS_LORENZ_CURVE_SPEC = {
    ...
    texts: [
      { x: 0.30, y: 0.60, text: 'Line of equality (45°)', tone: 'slate', bold: true, fontSize: 12, anchor: 'middle' },
      { x: 0.80, y: 0.30, text: 'Lorenz curve', tone: 'purple', bold: true, fontSize: 12, anchor: 'middle' },
      { x: 0.40, y: 0.78, text: 'Closer to the line', tone: 'green', fontSize: 11, anchor: 'middle' },
      { x: 0.40, y: 0.71, text: '= more equal', tone: 'green', bold: true, fontSize: 11, anchor: 'middle' }
    ]
  };
})();
