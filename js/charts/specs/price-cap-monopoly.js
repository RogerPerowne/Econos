...
(function () {
  ...
  window.ECONOS_PRICE_CAP_MONOPOLY_SPEC = {
    ...
    curves: [
      ...
      { id: '_cap', shape: { type: 'horizontal', y: 0.497, from: 0, to: 0.56 }, tone: 'purple', strokeWidth: 2.6, layer: 'pcm-2' }
    ],
    points: [
      ...
      /* Cap set at P = MC: the cap line meets MC exactly where MC crosses
         D = AR (allocative-efficiency point), so Q_c sits at that crossing. */
      { layer: 'pcm-2', intersection: { curves: ['MC', 'D'], near: [0.516, 0.497] }, tone: 'purple', radius: 6 }
    ],
    arrows: [
      ...
      { layer: 'pcm-2', x1: 0.516, y1: 0.497, x2: 0.516, y2: 0, tone: 'purple', strokeWidth: 1.3, dashed: '3 3', buffer: 0 },
      { layer: 'pcm-2', x1: 0.028, y1: 0.62, x2: 0.028, y2: 0.50, tone: 'purple', strokeWidth: 2.2, markerEnd: 'econos-arrow-purple', buffer: 0 },
      { layer: 'pcm-2', x1: 0.35, y1: 0.05, x2: 0.505, y2: 0.05, tone: 'green', strokeWidth: 2.2, markerEnd: 'econos-arrow-green', buffer: 0 }
    ],
    texts: [
      ...
      { layer: 'pcm-2', x: -0.02, y: 0.497, text: 'P_c', tone: 'purple', bold: true, anchor: 'end', fontSize: 12 },
      { layer: 'pcm-2', x: 0.33, y: 0.54, text: 'price cap', tone: 'purple', bold: true, anchor: 'start', fontSize: 10 },
      { layer: 'pcm-2', x: 0.516, y: -0.06, text: 'Q_c', tone: 'purple', bold: true, anchor: 'middle', fontSize: 12 },
      { layer: 'pcm-2', x: 0.06, y: 0.56, text: 'lower price', tone: 'purple', bold: true, anchor: 'start', fontSize: 9.5 },
      { layer: 'pcm-2', x: 0.43, y: 0.10, text: 'more output', tone: 'green', bold: true, anchor: 'middle', fontSize: 9.5 }
    ]
  };
})();
