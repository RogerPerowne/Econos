  ...
  cards: [
    ...
    /* ── CARD 4 ── What shifts AD? ───────────────────────────────── */
    {
      ...
      blocks: [
        ...
        { type: 'grid', cols: 2, children: [
          { type: 'tile', tone: 'blue', icon: '→', head: 'AD shifts right when…',
            body: '<ol style="margin:0;padding:0 0 0 18px;font-size:13px;line-height:1.7;color:#0B1426;"><li>Consumers feel wealthier and spend more.</li><li>Firms invest more in new capacity.</li><li>The government spends or transfers more.</li></ol>' },
          { type: 'tile', tone: 'amber', icon: '←', head: 'AD shifts left when…',
            body: '<ol style="margin:0;padding:0 0 0 18px;font-size:13px;line-height:1.7;color:#0B1426;"><li>Consumers feel worse off and spend less.</li><li>Firms invest less in new capacity.</li><li>The government cuts spending or raises taxes.</li></ol>' }
        ]},
        { type: 'bigIdea', text: 'Big idea: A change in any one engine can shift AD – but in reality several often move together.' },
        { type: 'examEdge', title: 'Exam edge (AQA)', text: 'Organise determinants by C, I, G and (X − M). That instantly gives essays better structure.' }
      ]
    },
    ...
    /* ── CARD 8 ── Evaluating AD analysis ────────────────────────── */
    {
      ...
      blocks: [
        ...
        { type: 'grid', cols: 3, children: [
          { type: 'tile', tone: 'blue',   icon: '⏸️', head: 'Multiplier size is uncertain',
            body: 'The effect depends on MPC, leakages and confidence. Quote a realistic UK figure (~1.5) rather than the textbook 2.5.' },
          { type: 'tile', tone: 'amber',  icon: '🧩', head: 'Composition of the shift',
            body: 'Different shocks have different multipliers. Capital G > current G > transfers > tax cuts. Investment shocks get amplified by the accelerator. The type of AD change matters as much as the size.' },
          { type: 'tile', tone: 'purple', icon: '⏳', head: 'Time lags',
            body: 'Policy effects take time – recognition lag, decision lag, then impact lag. Fiscal months, monetary 12–18 months.' },
          { type: 'tile', tone: 'green',  icon: '🏗️', head: 'AS constraints',
        ...
        { type: 'examEdge', title: 'Exam edge (AQA)', text: 'Strong essays start with AD, then qualify with lags, spare capacity, crowding out and animal spirits.' }
      ]
    }
