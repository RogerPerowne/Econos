/* ============================================================
   ...
   8 cards · AQA variant · AQA 3.2.2.5 + 3.2.2.6 / 4.2.2.5 + 6
   ─────────────────────────────────────────────────────────────
   AQA splits AS across two sub-sections: 3.2.2.5 covers
   determinants of SRAS (money wages, raw materials, business
   taxation, productivity), 3.2.2.6 covers LRAS determinants
   (technology, productivity, attitudes, enterprise, factor
   mobility, economic incentives) plus the institutional role
   of the banking system (4.2.2.6 (c)) and the Keynesian AS
   curve at A-level (4.2.2.6 (d)). Layout + diagrams identical
   to the Edexcel A baseline; copy emphasises AQA's explicit
   AS/A-level depth distinction.
   ============================================================ */
    ...
    /* ----- CARD 6 – Supply-side policies ----- */
    {
      ...
      blocks: [
        ...
        { type: 'grid', cols: 2, children: [
          { type: 'tile', tone: 'blue', icon: '💹', head: 'Tax cuts',
            body: 'Lower taxes to raise work incentives and investment. Fast · Low cost · Mixed evidence' },
          { type: 'tile', tone: 'blue', icon: '📋', head: 'Deregulation',
            body: 'Remove barriers to entry and reduce red tape. Fast · Low cost · Mixed evidence' },
          { type: 'tile', tone: 'blue', icon: '🏛️', head: 'Privatisation',
            body: 'Transfer state ownership to the private sector. Medium speed · Medium cost · Mixed evidence' },
          { type: 'tile', tone: 'blue', icon: '👥', head: 'Flexible labour markets',
            body: 'Easier hiring and firing to improve labour allocation. Fast · Low cost · Mixed evidence' }
        ]},
        { type: 'sectionHeader', icon: '🏗️', label: 'INTERVENTIONIST POLICIES' },
        { type: 'grid', cols: 2, children: [
          { type: 'tile', tone: 'amber', icon: '🎓', head: 'Education and training',
            body: 'Improve skills to lift productivity and earning potential. Slow · High cost · Strong evidence' },
          { type: 'tile', tone: 'amber', icon: '🛣️', head: 'Infrastructure',
            body: 'Invest in transport, energy and digital networks. Slow · High cost · Strong evidence' },
          { type: 'tile', tone: 'amber', icon: '🔬', head: 'R&D subsidies',
            body: 'Support research and innovation through grants or tax relief. Medium speed · Medium cost · Mixed evidence' },
          { type: 'tile', tone: 'amber', icon: '🏭', head: 'Industrial strategy',
            body: 'Target support for strategic sectors and clusters. Slow · High cost · Mixed evidence' }
        ]},
        { type: 'sectionHeader', icon: '🎯', label: 'WHEN EACH WORKS BEST' },
        { type: 'grid', cols: 2, children: [
          { type: 'tile', tone: 'blue',  icon: '👥', head: 'Market-based',
            body: 'Improves incentives and flexibility.' },
          { type: 'tile', tone: 'amber', icon: '👥', head: 'Interventionist',
            body: 'Builds human and physical capital.' }
        ]},
        { type: 'grid', cols: 3, children: [
          { type: 'tile', tone: 'blue',   icon: '⏱️', head: 'Speed',
            body: 'Market-based is faster. Interventionist takes time.' },
          { type: 'tile', tone: 'amber',  icon: '£',  head: 'Fiscal cost',
            body: 'Market-based is cheaper. Interventionist is costlier.' },
          { type: 'tile', tone: 'purple', icon: '👥', head: 'Distributional impact',
            body: 'Market-based can widen gaps. Interventionist can reduce them.' }
        ]},
