/* ============================================================
   ...
   8 cards · AQA variant · AQA 3.2.3.3 / 4.2.3.3
   ─────────────────────────────────────────────────────────────
   Tracks the AQA spec's framing for inflation: demand-pull and
   cost-push as on the SR/LR AS curves, the Fisher equation
   MV = PQ (AQA 4.2.3.3(c)) and the Quantity Theory anchored
   explicitly to the monetarist model, plus the role of
   expectations on the price level (4.2.3.3(d)). Layout +
   diagrams identical to the Edexcel A baseline; copy is tilted
   toward the AQA mark-scheme verbs (knowledge / application /
   analysis / evaluation in the 20–23 / 26–29 / 26–29 / 22–25
   weightings AQA uses at A-level).
   ============================================================ */
...
window.ECONOS_TOPIC = {
  ...
  goal: 'Diagnose inflation by cause – demand-pull, cost-push or monetary – evaluate the consequences, and match the right policy to each.',

  intro: {
    heroKey: 'heroAggSupply',
    summary: "Inflation does not have a single cause. Demand-pull comes from too much spending. Cost-push comes from squeezed supply. Monetary inflation is rooted in the Fisher identity MV = PQ – when money grows faster than output, price-level pressure follows. Expectations close the loop: if households and firms expect higher prices tomorrow, they act on it today. The same headline CPI figure can require opposite policy responses depending on its origin.",
    doInThis: 'Eight cards: the three causes, demand-pull and cost-push in detail, the AQA diagnosis (output direction + AD/AS signature), Fisher\'s MV = PQ and expectations, winners and losers, the dangers of deflation, and the AQA policy toolkit (monetary, fiscal, supply-side, expectations).',
    outcomes: [
      'Distinguish demand-pull, cost-push and monetary inflation by their AD/AS signatures',
      'Use output direction as the diagnostic tell (AQA 4.2.3.3 (b))',
      'Apply Fisher\'s equation of exchange MV = PQ to the monetarist model (AQA 4.2.3.3 (c))',
      'Evaluate the role of expectations on changes in the price level (AQA 4.2.3.3 (d))',
      'Evaluate the consequences of inflation and deflation for individuals and the wider economy',
      'Match the policy response to the underlying cause'
    ],
    tip: 'AQA rewards analysis chains that name the cause, draw the AD/AS diagram, and then evaluate against expectations and capacity. Diagnose first, then treat.',
    stages: [
  ...
  cards: [
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (AQA)',
        text: 'AQA AO3 chains explicitly link the diagram to the outcome: AD shifts right → higher price level (inflation) and higher real output. State the SRAS shape you are using (upward-sloping in the short run) so the price-level effect follows directly.'
      }
    },
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (AQA)',
        text: 'Cost-push inflation is harder to cure because inflation and recession appear together – AQA Paper 2 essays reward candidates who frame this as the SR Phillips-curve trade-off and evaluate against the LR vertical Phillips curve.'
      }
    },
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (AQA)',
        text: 'AQA Paper 2 mark schemes reward candidates who diagnose <em>before</em> recommending policy. Use AD/AS signatures explicitly: AD shift → demand-pull; SRAS shift → cost-push. AO3 marks accumulate when you justify the diagnosis with output direction.'
      }
    },
       ...
       ==================================================================== */
    {
      ...
      title: 'Fisher\'s MV = PQ, money and expectations',
      lede: 'Money and expectations can amplify inflation. AQA 4.2.3.3 (c) asks explicitly for Fisher\'s equation of exchange MV = PQ and the Quantity Theory of Money in relation to the monetarist model. But money growth alone does not mechanically create runaway inflation – velocity, capacity, and anchored expectations all complicate the simple M → P link.',
      ledeStyle: 'plain',

      tip: {
        icon: '✅',
        tone: 'green',
        text: '<strong>Fisher\'s identity is the starting point – the monetarist model layers expectations on top.</strong>'
      },
      ...
      letterFormula: {
        ...
        right: [
          ...
          { letter: 'Q', name: 'Real output (or T, transactions)', tone: 'purple' }
        ],
        caption: 'AQA spec wording: <em>"T may be used instead of Q; PQ as nominal national income avoids difficulties with intermediate transactions."</em> For a given level of real output (Q), higher money (M) raises prices (P) only if velocity (V) is stable. If V falls or spare capacity exists, extra money may not feed through to higher inflation – the monetarist story is a long-run claim.'
      },
      ...
      examEdge: {
        title: 'Exam edge (AQA)',
        text: 'AQA Paper 2 mark schemes reward candidates who use Fisher\'s identity MV = PQ <em>carefully</em>. State the equation, identify the monetarist long-run claim (M growth → P with V and Q stable), then qualify it: velocity, slack and anchored expectations explain why money does not automatically cause inflation in the short run.'
      },
      economistQuote: {
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (AQA)',
        text: 'AQA 4.2.3.3 (e) lists "the consequences of inflation for individuals and the performance of the economy" – the highest-mark evaluations turn on whether inflation is <strong>anticipated</strong>, on how quickly incomes / contracts adjust, and on the redistributive consequences for savers, borrowers and pensioners.'
      }
    },
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (AQA)',
        text: 'AQA 4.2.3.3 (f) asks for "the consequences of deflation for individuals and the performance of the economy" – not all falling prices are equally bad. The <em>cause</em> matters: deflation from weak AD is dangerous; deflation from a rightward AS shift can raise real incomes. AQA 4.2.3.3 (f) is explicit that deflationary policies reduce AD but do not necessarily result in deflation.'
      }
    },
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (AQA)',
        text: 'AQA Paper 2 essays reward candidates who judge policies by the cause of inflation, not just by whether they reduce CPI. Build the analysis chain: diagnosis → policy → AD/AS effect → trade-offs (SR Phillips curve) → evaluation (LR vertical Phillips curve, anchored expectations).'
      },
