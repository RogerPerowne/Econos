/* ============================================================
   ...
   7 cards · AQA variant · AQA 3.2.2.4 / 4.2.2.4
   ─────────────────────────────────────────────────────────────
   AQA's split: at AS (3.2.2.4) candidates calculate the
   multiplier from an initial change in injections and the
   resulting change in national income — no MPC formula
   required. At A-level (4.2.2.4) candidates add MPC and use
   k = 1/(1−MPC). MPC-based calculations from the marginal
   propensities to withdraw are NOT required at AQA — note the
   contrast with Edexcel A's k = 1/MPW. Layout identical to the
   Edexcel A baseline; copy flags this AS/A-level distinction.
   ============================================================ */
