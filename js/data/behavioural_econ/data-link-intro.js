...
window.ECONOS_LINK_INTRO = {
  ...
  intro: {
    ...
    stations: [
      { num: 1, name: 'Use the context',    skill: 'Application', sub: 'Read an extract and classify which evidence changes the case for nudges over taxes.',                           href: TopicLoader.buildUrl('link_context.html'), state: 'available' },
      { num: 2, name: 'Build the chain',    skill: 'Analysis',    sub: 'Order the steps that explain how present bias inflates demand and how nudges correct it.',                     href: TopicLoader.buildUrl('link_chain.html'),   state: 'available' },
      { num: 3, name: 'Diagram connector',  skill: 'Analysis',    sub: 'Pick, label and explain the demand-left diagram showing correction of present bias.',                          href: TopicLoader.buildUrl('link_diagram.html'), state: 'available' },
      { num: 4, name: 'It depends on',      skill: 'Evaluation',  sub: 'Rank the factors that most change whether nudges outperform Pigouvian taxes.',                                href: TopicLoader.buildUrl('link_depends.html'), state: 'available' },
