window.ECONOS_TOPIC = {
  ...
  cards: [

    {
      ...
      body: 'Traditional economics assumes <em>homo economicus</em> — fully rational, perfectly informed, with stable preferences. Behavioural economics shows this is wrong in <strong>systematic, predictable</strong> ways.<br><br><strong>Bounded rationality</strong> (Herbert Simon): we are rational <em>within limits</em>. Full optimisation is cognitively impossible — so we use mental shortcuts (<strong>heuristics</strong>). Most of the time these work fine. In specific contexts they produce predictable errors.<br><br><strong>Bounded self-control</strong>: even when we know the right answer, our present self over-rules our future self. This is why people smoke, over-eat, and under-save despite knowing better.<br><br><strong>Habitual behaviour</strong>: we repeat past choices to avoid the cognitive cost of re-deciding — buying the same brand of coffee for ten years without checking the price.',
      keyTerms: [
