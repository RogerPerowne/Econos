...
window.ECONOS_LINK_INTRO = {
  ...
  intro: {
    ...
    stations: [
      { num: 1, name: 'Use the context',    skill: 'Application', sub: 'Read an extract and classify which evidence changes the welfare case for the bus subsidy.',               href: TopicLoader.buildUrl('link_context.html'), state: 'available' },
      { num: 2, name: 'Build the chain',    skill: 'Analysis',    sub: 'Order the steps that explain how a per-unit subsidy shifts supply right and raises consumer surplus.',    href: TopicLoader.buildUrl('link_chain.html'),   state: 'available' },
      { num: 3, name: 'Diagram connector',  skill: 'Analysis',    sub: 'Pick, label and explain the supply and demand diagram for a production subsidy on bus travel.',           href: TopicLoader.buildUrl('link_diagram.html'), state: 'available' },
      { num: 4, name: 'It depends on',      skill: 'Evaluation',  sub: 'Rank the factors that most change whether the bus subsidy maximises consumer welfare.',                   href: TopicLoader.buildUrl('link_depends.html'), state: 'available' },
