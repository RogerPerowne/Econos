window.ECONOS_TOPIC = {
  ...
  cards: [
    ...
    /* ── Card 1: The Big Picture ─────────────────────────────────────── */
    {
      ...
      lede: 'Fixing a broken market can break it further — sometimes the cure costs more than the disease it was meant to treat.',
    ...
    /* ── Card 2: Causes of Government Failure ────────────────────────── */
    {
      ...
      lede: 'Four ways good intentions go wrong: distorted prices, side-effects nobody saw coming, costs that pile up, and a government that simply can\'t know enough.',
    ...
    /* ── Card 3: Regulatory Capture ─────────────────────────────────── */
    {
      ...
      lede: 'When the watchdog ends up working for the industry it\'s meant to police, consumers are the ones left exposed.',
    ...
    /* ── Card 4: Unintended Consequences ─────────────────────────────── */
    {
      ...
      lede: 'Pay people to kill cobras and they\'ll start farming them — every policy changes incentives, and people game them in ways no one predicted.',
    ...
    /* ── Card 5: Market Failure vs Government Failure ─────────────────── */
    {
      ...
      lede: 'The real exam question is never market or government — it\'s which one fails less, judged on size, certainty and reversibility.',
    ...
    /* ── Card 6: Government Failure in Practice ──────────────────────── */
    {
      ...
      lede: 'HS2, the CAP, Help to Buy, PFI — four real disasters, plus one reform that actually worked, give you ready-made exam ammunition.',
    ...
    /* ── Card 7: Reducing Government Failure ────────────────────────── */
    {
      ...
      lede: 'The fix isn\'t less government — it\'s smarter government: independent watchdogs, expiry dates, pilots and sunlight all cut the risk.',
