window.ECONOS_TOPIC = {
  ...
  cards: [
       ...
       ================================================================ */
    {
      ...
      lede: 'Demand reacts to more than a good\'s own price - it shifts with your income and with the price of related goods. These are the two lenses that capture that.',
       ...
       ================================================================ */
    {
      ...
      lede: 'When your pay rises, you buy more holidays but the same amount of bread - and bus trips might even fall. YED measures exactly which is which.',
  ...
  <div style="font-size:13px;color:#475569;margin-top:8px;line-height:1.6;">A <strong>positive</strong> YED means a normal good. A <strong>negative</strong> YED means an inferior good. The <strong>sign</strong> classifies the good – get it right first.</div>
       ...
       ================================================================ */
    {
      ...
      lede: 'A pay rise doesn\'t lift every purchase equally - necessities creep up, luxuries jump, and inferior goods can actually fall. YED maps the whole shift.',
       ...
       ================================================================ */
    {
      ...
      lede: 'When coffee gets pricier, tea sales rise and cafetiere sales fall - XED captures how the price of one good moves demand for another.',
       ...
       ================================================================ */
    {
      ...
      lede: 'The sign of XED tells you the direction; the size tells you how fierce the rivalry - whether a small price cut can steal a flood of customers.',
       ...
       ================================================================ */
    {
      ...
      lede: 'Two luxuries can have wildly different income sensitivities - these are the factors that decide whether the elasticity number comes out big or small.',
       ...
       ================================================================ */
    {
      ...
      lede: 'Recession, boom or price shock - elasticities turn a change in income or price into a real prediction about who wins and who loses.',
       ...
       ================================================================ */
    {
      ...
      lede: 'Almost every elasticity question is the same four moves: spot what changed, pick the formula, calculate, then say what it means. Here\'s the drill.',
