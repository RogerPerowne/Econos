  ...
  cards: [
...

    {
      ...
      interactiveDiagram: {
        ...
        wide: true,
        // No maxWidth cap: the spec's viewBox is now 700px wide (panels
        // scaled up), so it fills the card like every other chart and its
        // global-token labels render at ~12px instead of being magnified.
        layers: ['idl-1', 'idl-2'],
        views: [
          {
