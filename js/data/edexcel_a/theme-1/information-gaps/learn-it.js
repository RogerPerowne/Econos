window.ECONOS_TOPIC = {
  ...
  cards: [

    {
      ...
      lede: 'When one side of a deal knows more than the other, markets can make bad calls, lose trust, or break down entirely.',
...

    {
      ...
      lede: 'A Nobel-winning idea: when buyers can\'t tell good from bad, the good gets driven out and the whole market can spiral to junk.',
...

    {
      ...
      lede: 'From insurance to loans to second-hand goods, the same trap recurs – the riskiest or worst quality crowd into the market first.',
...

    {
      ...
      title: 'Moral Hazard',
      lede: 'Once you\'re insured or know you\'ll be bailed out, you start taking risks you\'d never take if you bore the full cost yourself.',
...

    {
      ...
      lede: 'Markets fight back against hidden information – a degree, a warranty, a star rating: clever ways to prove quality without the state stepping in.',
...

    {
      ...
      lede: 'When private fixes fall short, the state can force disclosure, license providers, or nudge us – but it can also get it badly wrong.',
...

    {
      ...
      lede: 'Healthcare hits every information failure at once – which is why the NHS-versus-private debate is the richest case study you can write about.',
