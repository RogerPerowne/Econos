window.ECONOS_TOPIC = {
  ...
  cards: [

    {
      ...
      title: 'Market failure',
      lede: 'Markets don\'t break down when they fail – they keep running, just churning out too much or too little of what society actually needs.',
...

    {
      ...
      lede: 'Externalities, public goods, information gaps – almost every way a market goes wrong traces back to one of these three culprits.',
...

    {
      ...
      lede: 'What looks like a great deal for you can be a bad one for everyone else – the gap between private and social is where market failure begins.',
...

    {
      ...
      lede: 'Produce the wrong amount and value just vanishes – not pocketed by anyone, simply lost. That missing surplus is the deadweight triangle.',
...

    {
      ...
      lede: 'Petrol, vaccines, street lighting, dodgy used cars – learn to spot which of the three failures is misfiring in any unseen scenario.',
