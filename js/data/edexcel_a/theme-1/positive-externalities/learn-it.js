  ...
  cards: [
    {
      ...
      lede: 'Your flu jab protects you — and quietly protects everyone around you too. That spillover is the benefit the market forgets to count.',
    ...
    },
    {
      ...
      lede: 'Vaccines, education, healthcare, even beehives — four cases where one person\'s choice quietly pays off for everyone else.',
    ...
    },
    {
      ...
      lede: 'Want people to do more of a good thing? Tweak the price. Subsidies and rewards can nudge output back up to where society wants it.',
    ...
    },
    {
      ...
      lede: 'Some benefits are too big to leave to a nudge — so government supplies the good itself, or simply makes it the law.',
    ...
    },
    {
      ...
      lede: 'Subsidies and free provision sound great — until you hit the catch: bad information, moral hazard, big bills and lobbyists all bite back.',
    ...
    },
    {
      ...
      title: 'Exam edge',
      lede: 'The phrases, the flow and the judgement framework that turn a solid answer into a top-band one.',
