...
<ul style="margin:8px 0 0 18px;line-height:1.8;">
  ...
  <li><strong>PES = ∞:</strong> Perfectly elastic – producers supply any amount at the going price; horizontal supply curve.</li>
      ...
      blocks: [
        { type: 'sectionHeader', icon: '📊', label: 'Supply responsiveness – from fixed to flexible' },
        { type: 'grid', cols: 3, children: [
          { type: 'tile', head: '🏗️ Housing – very inelastic (PES ≈ 0.1)', body: 'Planning permission takes years; construction takes 18+ months; land in specific locations is a fixed factor. A demand surge mostly becomes a price spike – output barely moves. The market adjusts almost entirely through price.' },
          { type: 'tile', head: '🏭 Manufacturing – elastic long-run (PES ≈ 1.5)', body: 'Firms can hire workers, extend shifts, and commission new plant over months. Long-run supply responds more than proportionally to price – a demand surge goes mostly into extra output, not higher prices. Time is the key unlock.' },
          { type: 'tile', head: '💻 Digital goods – near-perfectly elastic (PES → ∞)', body: 'Once created, software can be replicated at near-zero marginal cost. Any demand surge is met almost instantly and entirely through extra supply – price barely moves. The marginal cost of one more user is effectively zero.' }
        ]}
      ]
    },
