...
/* Inline SVG references — content extracted to js/diagrams/static/inline-extracted.js.
   Read from window.ECONOS_ICONS which is populated by that static file before app.js runs. */
const _MEP_I = window.ECONOS_ICONS || {};
const MEP_PPF_ACTUAL     = _MEP_I['mepPpfActualGrowth']    || '';
const MEP_PPF_POTENTIAL  = _MEP_I['mepPpfPotentialGrowth'] || '';
const MEP_GAP_POSITIVE   = _MEP_I['mepOutputGapPositive']  || '';
const MEP_GAP_NEGATIVE   = _MEP_I['mepOutputGapNegative']  || '';
const MEP_ADAS_SR        = _MEP_I['mepAdAsShortRun']        || '';
const MEP_ADAS_LR        = _MEP_I['mepAdAsLongRun']         || '';
