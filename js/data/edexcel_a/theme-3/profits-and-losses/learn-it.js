...
window.ECONOS_TOPIC = {
  ...
  intro: {
    ...
    summary: 'Profit is what survives once costs are paid out of revenue, measured through the core equation, break-even, profit per unit and profit margin. The Theme 3 task is to diagnose why profit changes — a price move, cost rise, productivity gain or competition squeeze — and link it to the business response.',
    doInThis: 'Calculate profit with TR − TC and read the profit and loss regions off a break-even chart. Compare two products using profit per unit and margin, then diagnose a change in profit and propose a sensible business response.',
    outcomes: [
