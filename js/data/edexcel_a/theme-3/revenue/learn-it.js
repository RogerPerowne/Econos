...
window.ECONOS_TOPIC = {
  ...
  intro: {
    heroKey: 'heroRevenue',
    summary: 'Revenue is the money a firm takes from selling its output – before any costs come off. It comes in three measures: total (TR), average (AR, income per unit) and marginal (MR, the next unit sold). Price elasticity of demand decides whether a price change raises or lowers TR – the link the exam keeps testing.',
