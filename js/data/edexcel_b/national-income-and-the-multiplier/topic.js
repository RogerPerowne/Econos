/* ============================================================
   ...
   7 cards · Edexcel B variant · Edexcel B 9EB0 § 4.4.1
   ─────────────────────────────────────────────────────────────
   Edexcel B sees the multiplier inside the AD/AS model
   (4.4.1 (e) — "the multiplier effect"). The Edexcel B
   evaluative lens is the impact on firms: bigger multipliers
   mean bigger swings in demand for firms' output, which feeds
   directly into capacity utilisation (2.3.2) and inventory
   management. Layout + diagrams identical to the Edexcel A
   baseline.
   ============================================================ */
