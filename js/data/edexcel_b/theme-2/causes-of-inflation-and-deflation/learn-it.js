/* ============================================================
   ...
   8 cards · Edexcel B variant · Edexcel B 9EB0 § 2.5.3
   ─────────────────────────────────────────────────────────────
   Edexcel B's framing is business-first. Theme 2 is "The wider
   economic environment" – inflation enters the spec as
   something that hits firms (uncertainty, loss of international
   competitiveness, eroded real margins) and individuals
   (loss of real income, savers vs borrowers). The macro
   mechanics are the same as Edexcel A; what changes is the
   evaluation lens. Layout + diagrams identical to the
   Edexcel A baseline; copy tilts every card toward firm-level
   and stakeholder impact, with explicit business case studies
   (Tesco, Premier Inn, manufacturing) layered on top of the
...
window.ECONOS_TOPIC = {
  ...
  topicNum: '2.5.3',
  theme: 'Theme 2 · The wider economic environment',
  title: 'Causes of Inflation & Deflation',
  estTime: '12-15 minutes',
  goal: 'Diagnose inflation by cause – demand-pull, cost-push or monetary – then evaluate the impact on firms and individuals and match the right policy to each cause.',

  intro: {
    heroKey: 'heroAggSupply',
    summary: "Inflation does not have a single cause. Demand-pull comes from too much spending. Cost-push comes from squeezed supply. Monetary and expectations-driven inflation comes from loose money and lost credibility. Edexcel B 2.5.3 (e) and (f) ask explicitly for the impact on firms (uncertainty, loss of international competitiveness, squeezed margins) and individuals (loss of real income, savers and borrowers). The same headline figure can require opposite responses from policymakers AND from firms.",
    doInThis: 'Eight cards: the three causes, demand-pull and cost-push in detail, how to spot the difference, money and expectations, the impact on firms and individuals (winners and losers), the dangers of deflation for business survival, and the policy toolkit.',
    outcomes: [
      'Distinguish demand-pull and cost-push inflation by their AD/AS signatures (Edexcel B 2.5.3 (d))',
      'Use output direction as the diagnostic tell',
      'Evaluate the impact of inflation on firms: uncertainty, loss of international competitiveness (Edexcel B 2.5.3 (e))',
      'Evaluate the impact on individuals: loss of real income, savers and borrowers (Edexcel B 2.5.3 (f))',
      'Match the policy response to the underlying cause (Edexcel B 2.6.2 / 4.4.2)'
    ],
    tip: 'Edexcel B essays reward candidates who diagnose AND apply – name the cause, then trace it through to specific firms or stakeholder groups.',
    stages: [
  ...
  cards: [
       ...
       ==================================================================== */
    {
      ...
      blocks: [
        ...
        { type: 'sectionHeader', icon: null, label: null },
        { type: 'grid', cols: 3, children: [
          { type: 'tile', tone: 'blue',   icon: '🛒', head: 'Demand-pull inflation',  body: 'Too much spending chasing too little output.' },
          { type: 'tile', tone: 'amber',  icon: '🏭', head: 'Cost-push inflation',    body: 'Firms face higher costs and pass them on.' },
          { type: 'tile', tone: 'purple', icon: '💭', head: 'Money & expectations',   body: 'Money growth and inflation psychology keep price rises going.' }
        ]},
        ...
        { type: 'bigIdea', text: '"Rising prices" is not a cause of inflation: Rising prices are the <strong>symptom</strong>. The <strong>cause</strong> is the underlying driver – demand, costs, money or expectations – that puts upward pressure on prices.' },
        { type: 'examEdge', title: 'Exam edge (Edexcel B)', text: 'Edexcel B Paper 2 mark schemes reward candidates who go beyond diagnosis to <strong>firm-level evaluation</strong>: name the cause, then trace it to specific business impacts (margins, pricing power, international competitiveness). The same CPI figure can mean different things for Tesco vs Rolls-Royce.' }
      ]
    },
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        ...
        text: 'The best Edexcel B answers link the diagram to the firm: AD shifts right → higher prices give firms <strong>pricing power</strong> and higher real output gives them <strong>sales volume</strong>. Both feed margin – which is the lens Edexcel B Paper 1/2 questions usually want.'
      }
    },
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (Edexcel B)',
        text: 'Cost-push hits firms doubly: higher input costs <strong>and</strong> weaker sales as households cut back. Edexcel B 2.5.3 (e) wants candidates to evaluate "uncertainty" and "loss of international competitiveness" as the headline business consequences.'
      }
    },
       ...
       ==================================================================== */
    {
      ...
      blocks: [
        ...
        { type: 'versusRows', title: 'Who benefits? Who loses?', emoji: '👥', leftTone: 'green', rightTone: 'rose', rows: [
          {
        ...
        { type: 'grid', cols: 2, children: [
          { type: 'tile', tone: 'blue',  icon: '🔮', head: 'Anticipated inflation',   body: 'People can plan ahead, set wages and prices, and use index-linking. <strong style="color:#2563EB;">Distributional effects are smaller.</strong>' },
          { type: 'tile', tone: 'amber', icon: '🔎', head: 'Unanticipated inflation',  body: 'Price rises outpace expectations. Some gain and others lose. <strong style="color:#D97706;">Distributional effects are larger.</strong>' }
        ]},
        { type: 'bigIdea', text: 'Governments and mortgage-holders: Governments and mortgage-holders can <strong>benefit</strong> when the real value of debt erodes, lowering the real cost of servicing and repaying debt.' },
        { type: 'examEdge', title: 'Exam edge (Edexcel B)', text: 'The strongest evaluation of winners and losers depends on <strong>expectations</strong> – and on how quickly incomes and contracts adjust to higher prices.' }
      ]
    },
