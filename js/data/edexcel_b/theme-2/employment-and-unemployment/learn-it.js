/* ============================================================
   ...
   8 cards · Edexcel B variant · Edexcel B 9EB0 § 2.5.4
   ─────────────────────────────────────────────────────────────
   Edexcel B 2.5.4 lists four sub-points: (a) employment,
   underemployment and unemployment, (b) measures of
   unemployment (claimant count and ILO), (c) causes
   (structural, occupational immobility, geographical
   immobility, technological, demand-deficient and cyclical),
   (d) impact of unemployment on firms and individuals. The
   "impact on firms" lens is the Edexcel B distinctive — labour
   costs, productivity, demand for output. Layout + diagrams
   identical to the Edexcel A baseline; copy tilts firm-ward.
   ============================================================ */
