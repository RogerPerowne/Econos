    ...
    /* ----- CARD 6 – Supply-side policies ----- */
    {
      ...
      blocks: [
        ...
        { type: 'grid', cols: 3, children: [
          { type: 'tile', tone: 'blue',   icon: '⏱️', head: 'Speed',              body: 'Market-based is faster. Interventionist takes time.' },
          { type: 'tile', tone: 'amber',  icon: '£',  head: 'Fiscal cost',        body: 'Market-based is cheaper. Interventionist is costlier.' },
          { type: 'tile', tone: 'purple', icon: '👥', head: 'Distributional impact', body: 'Market-based can widen gaps. Interventionist can reduce them.' }
        ]},
