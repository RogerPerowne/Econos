  ...
  window.ECONOS_QUIZ = {
    ...
    questions: [
      ...
      { type: 'diagnostic_pair',
        stem: 'Exam question: <em>"Evaluate the effectiveness of carbon taxes in reducing CO2 emissions."</em> Which student gives the stronger evaluative answer?',
        students: [
          { name: 'Priya', badge: 'Candidate A',
            answer: 'A carbon tax is theoretically effective because it internalises the negative externality, shifting MPC up to equal MSC and reducing output to Q*. However, effectiveness depends critically on the tax rate &mdash; if set below the social cost of carbon (estimated at &#163;51&ndash;&#163;185/tonne), the externality is only partially corrected. The UK\'s carbon floor price (around &#163;22/tonne for electricity) is arguably too low. A further limitation is carbon leakage: if only the UK imposes the tax, UK firms face higher costs while international competitors do not &mdash; output shifts abroad without global emissions falling. Demand for carbon-intensive goods (air travel, road fuel) is price-inelastic in the short run (PED &#8776; -0.1 to -0.3), so the quantity reduction may be small even at significant tax rates. Effectiveness improves when: the tax applies broadly, revenue funds compensatory transfers to low-income households (addressing regressivity), and is part of an international framework (Paris Agreement, carbon border adjustments).'
          },
          { name: 'James', badge: 'Candidate B',
            answer: 'Carbon taxes can reduce emissions by making pollution more expensive. If the tax is high enough, firms and consumers will use less carbon. For example, UK fuel duty is a type of carbon tax and people do drive less when petrol prices are high. However, carbon taxes can be unfair because they take a higher percentage of income from poor households who spend more on fuel and energy. Also, if other countries don\'t have carbon taxes, our industries might move abroad which would not help global emissions. The government could use the money raised to help with renewable energy or give it back to poor households. Overall carbon taxes can work but they need to be set at the right level and combined with other policies.'
          }
        ],
        ans: 0,
        exp: '<strong>Priya</strong> gives the stronger answer. She uses precise analytical frameworks: MPC/MSC diagram logic, the concept of optimal tax rate, specific UK data (carbon floor price &#163;22/tonne), price elasticity estimates, and the concepts of carbon leakage and regressivity. Critically, she conditions her evaluation: "effectiveness improves when..." &mdash; this is the hallmark of Level 4 analysis. James makes broadly correct points but at a descriptive rather than analytical level &mdash; no elasticity estimates, no diagram logic, no specific data. James would access Level 2&ndash;3; Priya Level 4.'
      },
