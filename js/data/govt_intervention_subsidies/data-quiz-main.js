  ...
  window.ECONOS_QUIZ = {
    ...
    questions: [
      ...
      { type: 'diagnostic_pair',
        stem: 'Exam question: <em>"Evaluate the use of subsidies to encourage the adoption of electric vehicles (EVs) in the UK."</em> Which student gives the stronger answer?',
        students: [
          { name: 'Amir', badge: 'Candidate A',
            answer: 'The UK Plug-in Vehicle Grant (up to &#163;5,000) corrects two market failures: (1) positive externality from reduced CO2 and air pollution &mdash; MPB &lt; MSB by the marginal environmental benefit; (2) information failure &mdash; consumers may underestimate long-run fuel and maintenance savings, leading to under-adoption. The subsidy increases quantity toward Q* and lowers the purchase price barrier. Evidence: UK EV market share rose from &lt;1% (2015) to ~16% (2022). However, the grant was phased out in 2022 as EV prices fell &mdash; suggesting the market was approaching competitiveness (infant industry logic). Limitations: (a) regressive benefit: the subsidy largely went to higher-income buyers who could afford EVs regardless; (b) additionality: some purchases would have happened without the subsidy (deadweight cost); (c) fiscal cost: ~&#163;300m+ spent; opportunity cost. On balance, the subsidy was effective as a transitional policy but withdrawal at the right time was important to avoid permanent dependence.'
          },
          { name: 'Sophie', badge: 'Candidate B',
            answer: 'EV subsidies helped the market grow by making cars cheaper for buyers. The positive externality of lower emissions justifies government help. The subsidy worked because EV sales increased a lot. However, EVs are still mainly bought by rich people so the subsidy was unfair as it mainly helped wealthy buyers. Also, the subsidy cost a lot of money that could have been used for other things. The government removed the grant in 2022, which suggests it was no longer needed. Some people argue that simply mandating that all new cars must be EVs by 2030 would be better than a subsidy because it gives a clear deadline, although this removes consumer choice. Overall subsidies helped start the EV market but regulation might be better in the long run.'
          }
        ],
        ans: 0,
        exp: '<strong>Amir</strong> gives the stronger answer. He explicitly identifies two distinct market failures being corrected (externality and information failure), uses precise diagram logic (MPB &lt; MSB), provides quantitative evidence (EV market share data), applies the infant industry framework to justify temporary subsidy, and analyses limitations with specific terminology (additionality, deadweight cost, regressivity). Sophie makes many of the same substantive points but without analytical structure &mdash; she describes the subsidy as "unfair" without the analytical framework linking incidence to price elasticity of demand among income groups. Amir accesses Level 4; Sophie Level 2&ndash;3.'
      },
