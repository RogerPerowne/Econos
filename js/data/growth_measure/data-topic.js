      ...
      branches: [
        {
          ...
          sub: 'The % change in <strong>real GDP</strong> over a period. Higher growth means more goods and services, rising incomes and improved living standards. Watch out for the difference between actual and potential growth.'
        },
        {
          tone: 'amber',
          label: '💷 Inflation (CPI / RPI)',
          sub: 'The % change in the <strong>general price level</strong>. High inflation erodes purchasing power and creates uncertainty for businesses and households. Target: 2% CPI in the UK.'
        },
        {
          tone: 'blue',
          label: '👷 Unemployment (ILO / claimant count)',
          sub: 'The % of the labour force that is <strong>unemployed and seeking work</strong>. High unemployment means wasted resources and personal hardship — the social and economic costs are both heavy.'
        },
        {
          tone: 'purple',
          label: '⚖️ Balance of payments (current account)',
          sub: 'Net <strong>trade in goods, services, income and transfers</strong>. A persistent current-account deficit signals reliance on foreign capital and can put downward pressure on the currency.'
        }
      ],
      examEdge: {
        title: 'Show how the four measures interact',
        text: 'Top marks come from explaining <strong>trade-offs</strong>, not just describing each indicator in isolation. Faster growth can push up inflation. Lower unemployment can worsen the current account. Anti-inflation policy can slow growth and raise unemployment. Policy is about <em>balance</em> — there are no free lunches.'
      }
    },
