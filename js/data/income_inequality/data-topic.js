window.ECONOS_TOPIC = {
  ...
  intro: {
    ...
    doInThis: 'Work through 9 cards covering Lorenz curve, Gini coefficient (with a worked calculation), income vs wealth inequality, causes of inequality, its consequences, redistribution tools, the equity-efficiency trade-off, and a 25-mark essay scaffold on reducing income inequality.',
    outcomes: [
