...
window.ECONOS_LINK_INTRO = {
  ...
  intro: {
    ...
    stations: [
      ...
      { num: 3, name: 'Diagram connector',  skill: 'Analysis',    sub: 'Pick, label, interpret and explain the right AD/AS diagram.',  href: TopicLoader.buildUrl('link_diagram.html'),  state: 'available' },
      { num: 4, name: 'It depends on',     skill: 'Evaluation',  sub: 'Rank the factors that most change the answer to a policy claim.',       href: TopicLoader.buildUrl('link_depends.html'),  state: 'available' },
      { num: 5, name: 'Make the judgement', skill: 'Evaluation',  sub: 'Synthesise context, chain, diagram and factors into an exam-quality judgement.', href: TopicLoader.buildUrl('link_judge.html'), state: 'available' }
    ],
