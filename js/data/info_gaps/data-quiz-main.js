(function () {
  ...
  window.ECONOS_QUIZ = {
    ...
    questions: [
      ...
      /* 9 — diagnostic_pair: NHS and information failure */
      { type: 'diagnostic_pair',
        stem: 'Exam question: <em>"Assess the view that information asymmetry provides the strongest justification for the NHS."</em> Which student gives the more rigorous answer?',
        students: [
          { name: 'Kezia', badge: 'Candidate A',
            answer: 'Information asymmetry in healthcare takes two forms. First, patients lack the medical knowledge to evaluate diagnoses, treatments, and drug prescriptions &#8212; classic adverse selection risk in private markets: doctors with financial incentives may over-prescribe (supplier-induced demand). Second, moral hazard: once insured (either NHS or private), patients may over-use low-value consultations. The NHS reduces both. Salaried NHS doctors lack financial incentives to over-prescribe &#8212; reducing supplier-induced demand risk. Universal risk pooling through taxation avoids the adverse selection spiral that afflicts private insurance markets (as US experience shows: 30 million uninsured pre-ACA, driven by adverse selection). However, the NHS does not eliminate moral hazard &#8212; free at point of use creates an incentive for trivial consultations. Moreover, information asymmetry is not the only justification for the NHS &#8212; positive externalities from treating infectious diseases, and equity concerns about price rationing healthcare, are arguably stronger arguments. The information asymmetry argument is compelling but partial: it explains why private markets fail in healthcare, not necessarily why government provision (rather than regulated private provision with disclosure mandates) is the only solution.'
          },
          { name: 'Aiden', badge: 'Candidate B',
            answer: 'Information asymmetry means that doctors know more than patients. This is a problem because patients cannot tell if the treatment they are given is the best one. In private healthcare, doctors might recommend unnecessary treatments to make money. The NHS avoids this by having doctors on salaries so they do not have a financial incentive to over-treat. Also, in a private market, people with pre-existing conditions might not be able to get health insurance because they are too risky. The NHS gives everyone healthcare regardless of their health status, which is fairer. Information asymmetry is therefore a strong justification for the NHS because it prevents exploitation of patients and ensures that everyone can access healthcare.'
          }
        ],
        ans: 0,
        exp: '<strong>Kezia</strong> gives the more rigorous answer. She identifies both forms of healthcare information asymmetry (adverse selection and moral hazard), applies both to the NHS, and then evaluates by showing the NHS solves one (adverse selection through universal pooling) but imperfectly manages the other (moral hazard through zero price). She references US experience quantitatively (30 million uninsured) and then crucially challenges the question &#8212; arguing information asymmetry explains why private markets fail, but not necessarily why NHS provision (rather than regulated private provision) is the solution. This is high-level evaluation. Aiden covers the same mechanisms but descriptively &#8212; he does not use the terms "adverse selection" or "moral hazard" analytically, and he does not challenge the question\'s framing. Kezia: Level 4; Aiden: Level 2.'
      },
