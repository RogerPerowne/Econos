...
(function () {
  ...
  window.ECONOS_QUIZ = {
    ...
    questions: [
      ...
      /* 8 — multi_select: evaluation of the National Minimum Wage and unemployment */
      { type: 'multi_select',
        stem: 'A student is writing a 25-mark essay on <strong>whether the National Minimum Wage causes unemployment</strong>. Which of the following statements demonstrate <strong>evaluation</strong> &#8212; as opposed to description or one-sided analysis?',
        opts: [
          'The competitive model predicts unemployment from a binding wage floor, but this conclusion depends on the degree of monopsony power in low-wage sectors: Card and Krueger (1994) and the UK Low Pay Commission consistently find small or zero disemployment, which is more consistent with the monopsony model than with perfect competition.',
          'A minimum wage set above the equilibrium wage creates excess supply of labour.',
          'The employment effect of the NMW varies significantly by region: in London, where the median wage is around &#163;19/hour, the &#163;11.44 NMW is well below equilibrium and has no disemployment effect; in low-wage northern regions, the floor is more binding and the unemployment risk is correspondingly larger.',
          'Firms may respond to NMW increases through non-wage margin adjustments &#8212; reducing hours, cutting non-wage benefits, or raising productivity demands &#8212; rather than cutting headcount, meaning aggregate employment statistics understate the true adjustment burden on affected workers.',
          'The National Minimum Wage was introduced in 1999 and has risen significantly since then.',
          'Monopsony means a single buyer in a market.'
        ],
        correct: [0, 2, 3],
        exp: '<strong>Option A</strong> is genuine evaluation: it concedes the competitive model prediction, but weighs it against empirical evidence (Card-Krueger, Low Pay Commission) and links the evidence to a theoretical qualification (monopsony), reaching a direction about which model better fits observed outcomes. <strong>Option C</strong> is evaluation: it introduces regional variation as a key contextual qualifier, using specific data (&#163;19/hour London vs &#163;11.44 NMW) to show the answer is conditional rather than universal &#8212; a contextualised, evidence-grounded conclusion. <strong>Option D</strong> is evaluation: it identifies a non-obvious transmission channel (non-wage margin adjustment), uses it to qualify what headline employment data shows, and reaches a nuanced direction about where the burden falls. <strong>Option B</strong> is description &#8212; it restates a model prediction without weighing it against evidence or qualification. <strong>Option E</strong> is pure description with no analytical content. <strong>Option F</strong> is a definition with no evaluative move.'
      },
