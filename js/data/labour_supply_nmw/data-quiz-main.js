...
(function () {
  ...
  window.ECONOS_QUIZ = {
    ...
    questions: [
      ...
      /* 10 — multi_select: evaluation of trade union effects */
      { type: 'multi_select',
        stem: 'A student is writing a 25-mark essay on <strong>the economic effects of trade unions on wages, employment, and efficiency</strong>. Which of the following statements demonstrate <strong>evaluation</strong> &#8212; as opposed to description or one-sided analysis?',
        opts: [
          'While trade unions raise wages for members in competitive markets, this comes at the cost of reduced employment for outsiders &#8212; the insider-outsider trade-off. However, this verdict reverses in monopsonistic markets, where unions act as countervailing power and raise both wages and employment, improving efficiency rather than reducing it.',
          'Trade unions raise wages for their members through collective bargaining.',
          'Freeman and Medoff\'s "voice" theory suggests that unions can raise productivity by reducing costly labour turnover and improving information flows between management and workers &#8212; a dynamic efficiency gain that the static wage-employment model ignores, potentially making the net welfare effect of unions positive.',
          'UK union density has fallen from 55% in 1979 to 23% in 2024, which means the union wage premium (estimated at 10-20%) and any associated efficiency effects are diminishing in importance &#8212; making arguments about unions less relevant to current UK labour market outcomes.',
          'Trade unions can have both positive and negative effects depending on the circumstances.',
          'Trade unions sometimes use strike action to achieve higher wages.'
        ],
        correct: [0, 2, 3],
        exp: '<strong>Option A</strong> is genuine evaluation: it presents the competitive model conclusion, then explicitly reverses the verdict under monopsony &#8212; reaching a direction that the welfare effect is market-structure-dependent, not uniformly negative. <strong>Option C</strong> is evaluation: it introduces the Freeman-Medoff voice theory as a counter-argument to the static efficiency-cost view, explaining the mechanism and reaching a direction that the net effect may be positive when dynamic gains are counted. <strong>Option D</strong> is evaluation: it uses specific data (55% → 23% density decline, 10-20% wage premium) to qualify the significance of the debate &#8212; reaching the direction that union effects matter less than they once did for aggregate UK outcomes. <strong>Option B</strong> is description &#8212; restating the basic function of unions with no qualification or direction. <strong>Option E</strong> is a vague "it depends" conclusion with no direction, no mechanism specified, and no evidence &#8212; the classic evaluation mistake. <strong>Option F</strong> is description of a union activity with no analytical weight.'
      }
