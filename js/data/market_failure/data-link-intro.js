...
window.ECONOS_LINK_INTRO = {
  ...
  intro: {
    ...
    stations: [
      { num: 1, name: 'Use the context',    skill: 'Application', sub: 'Read an extract and classify which evidence changes the case for mandatory disclosure in the used car market.',   href: TopicLoader.buildUrl('link_context.html'), state: 'available' },
      { num: 2, name: 'Build the chain',    skill: 'Analysis',    sub: 'Order the steps that explain the adverse selection spiral and why the market underproduces quality cars.',         href: TopicLoader.buildUrl('link_chain.html'),   state: 'available' },
      { num: 3, name: 'Diagram connector',  skill: 'Analysis',    sub: 'Pick, label and explain the demand-fall diagram for information asymmetry in the used car market.',               href: TopicLoader.buildUrl('link_diagram.html'), state: 'available' },
      { num: 4, name: 'It depends on',      skill: 'Evaluation',  sub: 'Rank the factors that most change whether mandatory disclosure corrects the information failure.',                href: TopicLoader.buildUrl('link_depends.html'), state: 'available' },
