...
(function () {
  ...
  window.ECONOS_QUIZ = {
    ...
    questions: [
      ...
      /* 8 — Multi-select: evaluation of monopolistic competition */
      { type: 'multi_select',
        stem: 'A student is writing a 25-mark essay on <strong>monopolistic competition</strong>. Which of the following statements demonstrate <strong>evaluation</strong> &#8212; as opposed to description or one-sided analysis?',
        opts: [
          'In monopolistic competition, P &gt; MC in long-run equilibrium, which means allocative inefficiency persists even after free entry eliminates supernormal profit',
          'The welfare cost of excess capacity depends on whether consumers value variety: if differentiation genuinely reflects different consumer preferences, the output gap below minimum AC may be the \'cost of variety\' rather than pure waste &#8212; a trade-off, not a clear market failure',
          'Monopolistic competition leads to excess capacity because profit-maximising output Q* lies to the left of minimum AC, so unit costs are above their technically achievable minimum',
          'Whether advertising in monopolistically competitive markets is welfare-reducing depends on whether it is informative &#8212; reducing consumer search costs &#8212; or purely persuasive, in which case it raises AC and prices without improving the underlying product',
          'The static inefficiency of monopolistic competition (P &gt; MC, excess capacity) should always be corrected through regulation requiring firms to produce at minimum AC',
          'Monopolistic competition is characterised by many firms, product differentiation, and free entry and exit, which together produce a long-run normal profit equilibrium'
        ],
        correct: [1, 3],
        exp: '<strong>Options B and D are evaluation.</strong> (B) makes the evaluative move of weighing the welfare cost against the consumer benefit of variety &#8212; qualifying the conclusion about excess capacity by introducing a competing consideration and reaching the direction that the outcome depends on how much consumers value differentiation. This is a genuine evaluative trade-off rather than one-sided analysis. (D) qualifies the welfare verdict on advertising by distinguishing informative from persuasive types, using that distinction to reach a directional conclusion for each case rather than a blanket judgement. <strong>Options A, C, E, and F are not evaluation.</strong> (A) correctly identifies P &gt; MC but is one-sided analysis &#8212; it does not weigh this against any counter-consideration or qualify the conclusion. (C) accurately describes the excess capacity result but is pure description of the diagram without evaluative weighing. (E) overclaims: it asserts a definitive policy conclusion without acknowledging that the \'cost of variety\' argument may justify the outcome in some markets, or that regulation imposes costs of its own. (F) is definition-level description with no evaluative content.'
      },
