(function () {
  ...
  window.ECONOS_QUIZ = {
    ...
    questions: [
      ...
      /* 9 — diagnostic_pair: evaluating negative externality policy */
      { type: 'diagnostic_pair',
        stem: 'Exam question: <em>"Evaluate the use of taxes to correct negative production externalities."</em> Which student evaluates more effectively?',
        students: [
          { name: 'Sophia', badge: 'Candidate A',
            answer: 'A Pigouvian tax equal to MEC internalises the externality by raising MPC to MSC, shifting the supply curve leftward to the socially optimal output. This is theoretically elegant: it uses the price mechanism (preserving firm choice about how to reduce output/pollution) and raises revenue for the Treasury. However, four key limitations apply. First, MEC must be measured accurately &#8212; but the social cost of carbon ranges from $51 to $185/tonne (IPCC), a 3x range, making optimal tax-setting impossible. Setting the tax too low leaves overproduction; too high causes under-production. Second, demand for many polluting goods is price-inelastic (fuel, energy) &#8212; the tax raises revenue but may achieve only modest quantity reductions. Third, energy taxes are regressive &#8212; they consume a higher share of low-income budgets, creating distributional concerns. Fourth, carbon leakage: if UK carbon taxes rise but competitors do not match them, production shifts abroad &#8212; global emissions unchanged, UK competitiveness harmed. Regulation (guaranteed output reduction) or cap-and-trade (quantity certainty plus tradeable efficiency) may be superior in specific contexts.'
          },
          { name: 'Leo', badge: 'Candidate B',
            answer: 'A tax on firms that produce negative externalities can help to fix the market failure. If the tax equals the external cost, firms will reduce their output to the level that is best for society. This is because the higher costs reduce their profits and so they produce less. The tax also raises money for the government which can be used for other things. However, the tax might not work perfectly. It is hard to know exactly how much to charge. Also, people might still buy the goods even with the tax, especially if they need them. Taxes can also be unpopular and hard to enforce. Overall taxes can help with externalities but they have limitations and might not be the best policy in all cases.'
          }
        ],
        ans: 0,
        exp: '<strong>Sophia</strong> gives the stronger answer. She uses precise analytical terminology (Pigouvian tax, MEC, MPC, MSC), identifies the mechanism diagrammatically (supply shift to Q-optimal), and then evaluates with four specific, evidence-referenced limitations: measurement uncertainty (IPCC range), price-inelastic demand, regressivity, and carbon leakage. She concludes comparatively &#8212; suggesting when alternatives might be superior. Leo identifies the same general points but at a narrative level without the analytical framework, quantitative specificity, or comparative conclusion. Sophia: Level 4; Leo: Level 2&#8211;3. The mark-scheme differentiator: Sophia names the mechanism and then names specific reasons why it might fail, with evidence.'
      },
