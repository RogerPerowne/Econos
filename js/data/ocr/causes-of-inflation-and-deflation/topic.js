/* ============================================================
   ...
   8 cards · OCR variant · OCR H460 Component 2 § 2.4
   ─────────────────────────────────────────────────────────────
   OCR 2.4 (a) distinguishes inflation, deflation, disinflation
   AND hyperinflation explicitly — adds the hyperinflation
   evaluation thread the other boards don't ask for. The whole
   spec sub-section is framed in evaluate-verbs: "evaluate
   causes and consequences of inflation and deflation". Layout +
   diagrams identical to the Edexcel A baseline; copy retunes
   to OCR's four-equal AO weighting (25% × 4) and the OCR habit
   of dropping in hyperinflation case studies (Weimar, Zimbabwe,
   Venezuela) as application anchors.
   ============================================================ */
...
window.ECONOS_TOPIC = {
  ...
  goal: 'Evaluate the causes and consequences of inflation, deflation, disinflation and hyperinflation – and match the right policy to each cause.',

  intro: {
    heroKey: 'heroAggSupply',
    summary: "Inflation does not have a single cause. Demand-pull comes from too much spending. Cost-push comes from squeezed supply. Monetary inflation comes from money growth running ahead of output – the extreme case is hyperinflation, where price-level expectations collapse. OCR 2.4 (a) lists all four states – inflation, deflation, disinflation, hyperinflation – and the same CPI figure can require opposite policy responses depending on which one you are in.",
    doInThis: 'Eight cards: the three causes (and the hyperinflation extreme), demand-pull and cost-push in detail, how to spot the difference using OCR\'s evaluate criteria, money and expectations, winners and losers, the dangers of deflation, and the policy toolkit – built to support OCR\'s four-equal AO weighting.',
    outcomes: [
      'Distinguish inflation, deflation, disinflation and hyperinflation (OCR 2.4 (a))',
      'Evaluate causes and consequences of inflation and deflation (OCR 2.4 (f))',
      'Calculate the rate of inflation using index numbers (OCR 2.4 (e))',
      'Use real and nominal values to evaluate the impact of inflation (OCR 2.4 (c))',
      'Match the policy response to the underlying cause'
    ],
    tip: 'OCR mark schemes reward explicit evaluate verbs. Diagnose first, then evaluate the policy. The same CPI figure can hide very different macroeconomic stories.',
    stages: [
  ...
  cards: [
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (OCR)',
        text: 'OCR extended responses expect candidates to evaluate <em>both</em> sides of the diagram: AD shifts right → higher price level and higher real output, BUT only if there is spare capacity. Mention the capacity constraint to lift AO3 marks into AO4 territory.'
      }
    },
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (OCR)',
        text: 'Cost-push inflation is harder to cure because inflation and recession appear together – evaluate the policy dilemma using OCR\'s Phillips Curve content (OCR 2.8): tighten to fight inflation and you push along the SR curve, raising unemployment.'
      }
    },
       ...
       ==================================================================== */
    {
      ...
      examEdge: {
        title: 'Exam edge (OCR)',
        text: 'OCR 5.1 (d) introduces Fisher\'s equation of exchange explicitly in the financial-sector content. Strong Component 2 answers use it <em>carefully</em>: state the identity, then evaluate it against velocity changes, spare capacity and anchored expectations.'
      },
      economistQuote: {
