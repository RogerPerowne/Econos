/* ============================================================
   ...
   8 cards · OCR variant · OCR H460 Component 2 § 1.2
   ─────────────────────────────────────────────────────────────
   OCR 1.2 has four sub-points: (a) AD and its components,
   (b) the relationship between AD and price level (with
   diagram), (c) shifts in the AD curve, (d) evaluate the
   relationship between changes in income and consumption,
   (e) evaluate the role of expectations. The OCR habit of
   "evaluate" verbs is woven through. Layout + diagrams
   identical to the Edexcel A baseline; copy retunes to OCR's
   four-equal AO weighting and explicit evaluation prompts.
   ============================================================ */
