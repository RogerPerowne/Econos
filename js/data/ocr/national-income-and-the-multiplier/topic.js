/* ============================================================
   ...
   7 cards · OCR variant · OCR H460 Component 2 § 1.5
   ─────────────────────────────────────────────────────────────
   OCR 1.5 bundles the multiplier AND the accelerator: (a)
   factors determining the size of the multiplier, (b) the
   multiplier and accelerator (diagram), (c) impact on AD and
   the economic cycle, (d) output gaps via AD/AS and a PPC,
   (e) explain and calculate average and marginal propensities
   to consume, save and withdraw, (f) calculate the size of
   the multiplier, (g) evaluate causes and consequences of
   output gaps. The OCR accelerator content goes beyond what
   Edexcel A asks for. Layout identical; copy flags accelerator.
   ============================================================ */
