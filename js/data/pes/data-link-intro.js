...
window.ECONOS_LINK_INTRO = {
  ...
  intro: {
    ...
    stations: [
      { num: 1, name: 'Use the context',    skill: 'Application', sub: 'Read an extract and classify which evidence changes the case for low PES driving rents.',        href: TopicLoader.buildUrl('link_context.html'), state: 'available' },
      { num: 2, name: 'Build the chain',    skill: 'Analysis',    sub: 'Order the steps that explain why a demand surge caused a rent spike rather than a supply surge.', href: TopicLoader.buildUrl('link_chain.html'),   state: 'available' },
      { num: 3, name: 'Diagram connector',  skill: 'Analysis',    sub: 'Pick, label and explain the demand-right diagram with inelastic housing supply.',                 href: TopicLoader.buildUrl('link_diagram.html'), state: 'available' },
      { num: 4, name: 'It depends on',      skill: 'Evaluation',  sub: 'Rank the factors that most change whether low PES explains the rent spike.',                      href: TopicLoader.buildUrl('link_depends.html'), state: 'available' },
