(function () {
  ...
  window.ECONOS_QUIZ = {
    ...
    questions: [
      ...
      /* 9 — multi_select: evaluation of public provision for positive externalities */
      { type: 'multi_select',
        stem: 'A student is writing a 25-mark essay on positive externalities and government intervention. Which of the following statements demonstrate <strong>evaluation</strong> &#8212; as opposed to description or one-sided analysis?',
        opts: [
          'Public provision of vaccination is justified because it removes the price barrier and increases consumption.',
          'While free public provision of healthcare eliminates the underconsumption problem by removing the price barrier, the zero marginal cost to users creates moral hazard &#8212; pushing consumption above the social optimum &#8212; so co-payments calibrated to the size of the externality may dominate full provision for elective procedures.',
          'The case for subsidising education rather than providing it publicly is stronger when the private benefit (graduate premium) is large relative to the external benefit: where MSB &#8722; MPB is small, targeted subsidies are sufficient; where it is large (e.g. vaccination), full public provision is better justified.',
          'Positive externalities cause MSB to exceed MPB, leading to underconsumption in the free market.',
          'Government provision of education is not always superior to subsidies &#8212; in countries with weak state capacity, public provision may generate allocative inefficiency and crowding out of private innovation, suggesting the optimal instrument depends on institutional quality as well as the size of the externality.',
          'Subsidies and public provision both correct positive externalities, so there is no difference between the two policies.'
        ],
        correct: [1, 2, 4],
        exp: '<strong>Option A</strong> is description: it states why free provision matters but makes no evaluative move &#8212; no weighing of trade-offs, no qualification, no direction on when this logic holds or fails. <strong>Option B</strong> is strong evaluation: it acknowledges the validity of public provision, then introduces a specific counter-mechanism (moral hazard at zero marginal cost) and derives a conditional policy recommendation (co-payments for elective procedures). This weighs competing considerations and gives a direction. <strong>Option C</strong> is evaluation: it uses the magnitude of the external benefit relative to private benefit as an analytical lens to differentiate between instruments, reaching a conditional conclusion with examples. <strong>Option D</strong> is pure description of the market failure mechanism with no evaluative content. <strong>Option E</strong> is evaluation: it qualifies the case for government provision with institutional feasibility, drawing on a broader framework to reach a conditional conclusion. This is a genuine higher-order evaluative move. <strong>Option F</strong> is a one-sided dismissal that ignores real differences between instruments (who bears the cost, incentive effects, targeting efficiency) &#8212; it overclaims equivalence without evidence.'
      },
