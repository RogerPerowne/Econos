...
window.ECONOS_LINK_INTRO = {
  ...
  intro: {
    ...
    stations: [
      ...
      { num: 3, name: 'It depends on',      skill: 'Evaluation',  sub: 'Rank the factors that most change whether the long-run PPF shift justifies the short-run opportunity cost.',     href: TopicLoader.buildUrl('link_depends.html'), state: 'available' },
      { num: 4, name: 'Make the judgement', skill: 'Evaluation',  sub: 'Synthesise context, chain and conditions into an exam-quality judgement on the green investment trade-off.',      href: TopicLoader.buildUrl('link_judge.html'),   state: 'available' }
    ],
