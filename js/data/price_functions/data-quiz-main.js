(function () {
  ...
  window.ECONOS_QUIZ = {
    ...
    questions: [
      ...
      /* 9 — diagnostic_pair: price vs government allocation */
      { type: 'diagnostic_pair',
        stem: 'Exam question: <em>"Assess the view that the price mechanism is the most efficient way to allocate resources."</em> Which student evaluates more effectively?',
        students: [
          { name: 'Amara', badge: 'Candidate A',
            answer: 'The price mechanism excels at allocating private goods when it accurately signals costs and benefits: it aggregates dispersed knowledge (Hayek), incentivises efficient production through the profit motive, and rations goods to highest-value uses without bureaucratic costs. However, efficiency claims rest on the assumption that prices reflect all social costs and benefits. Where externalities exist &#8212; carbon emissions, pollution, vaccination &#8212; prices systematically understate social costs or overstate private costs, producing allocative inefficiency. Similarly, for public goods (non-excludable, non-rival), the price mechanism fails completely: no private firm can recover costs. Information asymmetries (used cars, insurance, healthcare) further distort prices. The normative dimension also matters: price rationing allocates to willingness to pay, not need &#8212; an equity argument, not an efficiency one. The conclusion is that the price mechanism is the most efficient <em>feasible</em> allocator for private goods with no externalities; but government intervention is needed wherever these conditions are not met &#8212; which, in practice, covers a substantial fraction of a modern economy.'
          },
          { name: 'Dan', badge: 'Candidate B',
            answer: 'The price mechanism allocates resources through supply and demand. When prices rise, firms are incentivised to produce more, and consumers reduce demand. This leads to an equilibrium where the market clears. This is efficient because resources go where they are most valued. However, the price mechanism does not always work. For example, with public goods like defence, the government must provide them because firms would not make a profit. Externalities are another case where markets fail. Overall, the price mechanism is good for most goods but the government needs to step in when it fails. The free market and government both have roles to play in a modern economy.'
          }
        ],
        ans: 0,
        exp: '<strong>Amara</strong> gives the stronger answer. She identifies the conditions under which the price mechanism is efficient (private goods, no externalities), then systematically analyses the three main categories of market failure that break these conditions. She links each failure to a specific function of the price mechanism (externalities &#8658; signal failure; public goods &#8658; incentive failure; information &#8658; signal/rationing failure). She also introduces the normative dimension (equity vs efficiency), showing evaluative depth. Dan covers the same territory at a descriptive level &#8212; he identifies market failure types but does not connect them analytically to the price mechanism\'s specific functions. Amara: Level 4; Dan: Level 2&#8211;3.'
      },
