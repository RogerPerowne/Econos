...
window.ECONOS_LINK_INTRO = {
  ...
  intro: {
    ...
    outcomes: [
      ...
      'Read a diagram showing how free riding collapses effective market demand',
    ...
    stations: [
      ...
      { num: 3, name: 'Diagram connector',  skill: 'Analysis',    sub: 'Pick, label and explain the demand diagram showing how free riding collapses private market demand.',        href: TopicLoader.buildUrl('link_diagram.html'), state: 'available' },
