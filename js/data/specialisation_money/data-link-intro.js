...
window.ECONOS_LINK_INTRO = {
  ...
  intro: {
    ...
    stations: [
      ...
      { num: 3, name: 'Predict the Outcome', skill: 'Analysis',    sub: 'Predict the market outcomes of trade deal breakdowns and barter failure scenarios.',                href: TopicLoader.buildUrl('link_predict.html'), state: 'available' },
      { num: 4, name: 'It depends on',       skill: 'Evaluation',  sub: 'Rank the factors that most change whether specialisation raises productivity.',                     href: TopicLoader.buildUrl('link_depends.html'), state: 'available' },
