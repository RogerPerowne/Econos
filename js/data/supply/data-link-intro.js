...
window.ECONOS_LINK_INTRO = {
  ...
  intro: {
    ...
    stations: [
      ...
      { num: 2, name: 'Build the chain',    skill: 'Analysis',    sub: 'Order the steps that explain how rising energy costs shift the supply curve and move the equilibrium.',  href: TopicLoader.buildUrl('link_chain.html'),   state: 'available' },
      { num: 3, name: 'Diagram connector',  skill: 'Analysis',    sub: 'Pick, label and explain the supply-shift diagram for the UK energy price shock.',                        href: TopicLoader.buildUrl('link_diagram.html'), state: 'available' },
      { num: 4, name: 'It depends on',      skill: 'Evaluation',  sub: 'Rank the factors that most change whether energy costs are the dominant supply-side shock.',             href: TopicLoader.buildUrl('link_depends.html'), state: 'available' },
