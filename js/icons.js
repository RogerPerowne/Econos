...
window.ECONOS_ICONS = {
  ...
  heroSupplyDemand: `
    <svg viewBox="0 0 280 360" width="280" height="360" xmlns="http://www.w3.org/2000/svg" font-family="Inter, sans-serif">
      <defs>
        <pattern id="dots-sd" x="0" y="0" width="14" height="14" patternUnits="userSpaceOnUse">
          <circle cx="2" cy="2" r="1" fill="#CBD5E1"/>
        </pattern>
        <linearGradient id="bg-sd" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stop-color="#F0F9FF"/>
          <stop offset="100%" stop-color="#FFFFFF"/>
        </linearGradient>
      ...
      <!-- background -->
      <rect x="0" y="0" width="280" height="360" rx="16" fill="url(#bg-sd)"/>
      <rect x="0" y="0" width="280" height="360" rx="16" fill="url(#dots-sd)" opacity="0.4"/>

      <!-- chart frame card -->
      <g filter="url(#shadow-sd)">
      ...
      <text x="140" y="40" font-size="10" font-weight="800" fill="#0F172A"
            text-anchor="middle" letter-spacing="3" opacity="0.65">EQUILIBRIUM</text>
      ...
      <!-- Demand curve (green, downward) -->
      <path d="M 70 100 Q 130 160 240 270" stroke="#1FB574" stroke-width="3"
            fill="none" stroke-linecap="round" filter="url(#shadow-sd)"/>
      <text x="80" y="112" font-size="13" font-weight="800" fill="#1FB574">D</text>

      <!-- Supply curve (blue, upward) -->
      <path d="M 70 270 Q 150 230 240 100" stroke="#3B82F6" stroke-width="3"
            fill="none" stroke-linecap="round" filter="url(#shadow-sd)"/>
      <text x="226" y="112" font-size="13" font-weight="800" fill="#3B82F6">S</text>

      <!-- equilibrium dashed lines -->
      <line x1="60" y1="190" x2="150" y2="190" stroke="#0F172A" stroke-width="1.2"
            stroke-dasharray="3 3" opacity="0.55"/>
      <line x1="150" y1="190" x2="150" y2="280" stroke="#0F172A" stroke-width="1.2"
            stroke-dasharray="3 3" opacity="0.55"/>

      <!-- equilibrium dot -->
      <g filter="url(#shadow-sd)">
        <circle cx="150" cy="190" r="6" fill="#FFFFFF" stroke="#0F172A" stroke-width="2"/>
        <circle cx="150" cy="190" r="2.5" fill="#EC2D68"/>
      </g>

      <!-- P* and Q* labels -->
      <text x="52" y="194" font-size="11" font-weight="800" fill="#0F172A" text-anchor="end">P*</text>
      <text x="150" y="298" font-size="11" font-weight="800" fill="#0F172A" text-anchor="middle">Q*</text>
  ...
  heroElasticity: `
    <svg viewBox="0 0 280 360" width="280" height="360" xmlns="http://www.w3.org/2000/svg" font-family="Inter, sans-serif">
      <defs>
        <pattern id="dots-el" x="0" y="0" width="14" height="14" patternUnits="userSpaceOnUse">
          <circle cx="2" cy="2" r="1" fill="#CBD5E1"/>
        </pattern>
        <linearGradient id="bg-el" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stop-color="#F0F9FF"/>
          <stop offset="100%" stop-color="#FFFFFF"/>
        </linearGradient>
        <filter id="shadow-el" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="2" stdDeviation="2" flood-color="#0F172A" flood-opacity="0.15"/>
        </filter>
      </defs>

      <!-- background -->
      <rect x="0" y="0" width="280" height="360" rx="16" fill="url(#bg-el)"/>
      <rect x="0" y="0" width="280" height="360" rx="16" fill="url(#dots-el)" opacity="0.4"/>

      <!-- header caption -->
      <text x="140" y="38" font-size="10" font-weight="800" fill="#0F172A"
            text-anchor="middle" letter-spacing="3" opacity="0.65">RESPONSIVENESS</text>

      <!-- chart card -->
      <g filter="url(#shadow-el)">
        <rect x="30" y="55" width="220" height="245" rx="10" fill="#FFFFFF" stroke="#E2E8F0" stroke-width="1.5"/>
      </g>

      <!-- gridlines -->
      <g stroke="#E2E8F0" stroke-width="1" opacity="0.6">
        <line x1="60" y1="110" x2="230" y2="110"/>
        <line x1="60" y1="160" x2="230" y2="160"/>
        <line x1="60" y1="220" x2="230" y2="220"/>
        <line x1="110" y1="80" x2="110" y2="270"/>
        <line x1="165" y1="80" x2="165" y2="270"/>
      </g>

      <!-- axes -->
      <line x1="60" y1="80" x2="60" y2="270" stroke="#0F172A" stroke-width="2" stroke-linecap="round"/>
      <line x1="60" y1="270" x2="230" y2="270" stroke="#0F172A" stroke-width="2" stroke-linecap="round"/>
      <polygon points="60,76 56,86 64,86" fill="#0F172A"/>
      <polygon points="234,270 224,266 224,274" fill="#0F172A"/>
      <text x="52" y="78" font-size="10" font-weight="800" fill="#0F172A" text-anchor="end">P</text>
      <text x="238" y="282" font-size="10" font-weight="800" fill="#0F172A">Q</text>

      <!-- Inelastic (steep) — amber -->
      <path d="M 115 90 L 135 270" stroke="#F5B800" stroke-width="3.5"
            fill="none" stroke-linecap="round" filter="url(#shadow-el)"/>
      <!-- Elastic (flat) — green -->
      <path d="M 70 175 L 225 200" stroke="#1FB574" stroke-width="3.5"
            fill="none" stroke-linecap="round" filter="url(#shadow-el)"/>

      <!-- small reference dots -->
      <circle cx="125" cy="180" r="4" fill="#FFFFFF" stroke="#F5B800" stroke-width="2"/>
      <circle cx="150" cy="192" r="4" fill="#FFFFFF" stroke="#1FB574" stroke-width="2"/>

      <!-- inelastic pill -->
      <g transform="translate(150, 95)" filter="url(#shadow-el)">
        <rect x="0" y="0" width="80" height="22" rx="11" fill="#FEF3C7" stroke="#F5B800" stroke-width="1.5"/>
        <text x="40" y="15" font-size="9" font-weight="800" fill="#92400E"
              text-anchor="middle" letter-spacing="2">INELASTIC</text>
      </g>
      <line x1="150" y1="106" x2="135" y2="150" stroke="#F5B800" stroke-width="1.2"
            stroke-dasharray="3 3" opacity="0.7"/>

      <!-- elastic pill -->
      <g transform="translate(70, 230)" filter="url(#shadow-el)">
        <rect x="0" y="0" width="68" height="22" rx="11" fill="#DCFCE7" stroke="#1FB574" stroke-width="1.5"/>
        <text x="34" y="15" font-size="9" font-weight="800" fill="#065F46"
              text-anchor="middle" letter-spacing="2">ELASTIC</text>
      </g>
      <line x1="138" y1="241" x2="160" y2="195" stroke="#1FB574" stroke-width="1.2"
            stroke-dasharray="3 3" opacity="0.7"/>

      <!-- footer caption -->
      <text x="140" y="328" font-size="9" font-weight="700" fill="#475569"
            text-anchor="middle" letter-spacing="2" opacity="0.75">STEEP = NEED. FLAT = CHOICE.</text>
    </svg>
  `,
  heroPPF: `
    <svg viewBox="0 0 280 360" width="280" height="360" xmlns="http://www.w3.org/2000/svg" font-family="Inter, sans-serif">
      <defs>
        <pattern id="dots-ppf" x="0" y="0" width="14" height="14" patternUnits="userSpaceOnUse">
          <circle cx="2" cy="2" r="1" fill="#CBD5E1"/>
        </pattern>
        <linearGradient id="bg-ppf" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stop-color="#F0F9FF"/>
          <stop offset="100%" stop-color="#FFFFFF"/>
        </linearGradient>
        <filter id="shadow-ppf" x="-20%" y="-20%" width="140%" height="140%">
          <feDropShadow dx="0" dy="2" stdDeviation="2" flood-color="#0F172A" flood-opacity="0.15"/>
        </filter>
      </defs>

      <!-- background -->
      <rect x="0" y="0" width="280" height="360" rx="16" fill="url(#bg-ppf)"/>
      <rect x="0" y="0" width="280" height="360" rx="16" fill="url(#dots-ppf)" opacity="0.4"/>

      <!-- header caption -->
      <text x="140" y="38" font-size="10" font-weight="800" fill="#0F172A"
            text-anchor="middle" letter-spacing="3" opacity="0.65">PRODUCTION FRONTIER</text>

      <!-- chart card -->
      <g filter="url(#shadow-ppf)">
        <rect x="30" y="55" width="220" height="250" rx="10" fill="#FFFFFF" stroke="#E2E8F0" stroke-width="1.5"/>
      </g>

      <!-- feasible region (light grey shaded interior under curve) -->
      <path d="M 60 270 L 60 110 Q 100 270 230 270 Z"
      ...
      <g stroke="#E2E8F0" stroke-width="1" opacity="0.6">
        ...
        <line x1="120" y1="80" x2="120" y2="270"/>
        <line x1="180" y1="80" x2="180" y2="270"/>
      </g>

      <!-- axes -->
      <line x1="60" y1="80" x2="60" y2="270" stroke="#0F172A" stroke-width="2" stroke-linecap="round"/>
      <line x1="60" y1="270" x2="240" y2="270" stroke="#0F172A" stroke-width="2" stroke-linecap="round"/>
      <polygon points="60,76 56,86 64,86" fill="#0F172A"/>
      <polygon points="244,270 234,266 234,274" fill="#0F172A"/>

      <!-- axis labels -->
      <text x="52" y="92" font-size="8" font-weight="800" fill="#0F172A"
            text-anchor="end" letter-spacing="1">CAPITAL</text>
      <text x="52" y="102" font-size="8" font-weight="800" fill="#0F172A"
            text-anchor="end" letter-spacing="1">GOODS</text>
      <text x="230" y="288" font-size="8" font-weight="800" fill="#0F172A"
            text-anchor="end" letter-spacing="1">CONSUMER GOODS</text>

      <!-- PPF curve (bowed out, green) -->
      <path d="M 60 110 Q 100 270 230 270" stroke="#1FB574" stroke-width="3.5"
            fill="none" stroke-linecap="round" filter="url(#shadow-ppf)"/>
      ...
      <!-- inefficient point inside region -->
      <g filter="url(#shadow-ppf)">
        <circle cx="100" cy="240" r="5" fill="#FFFFFF" stroke="#EC2D68" stroke-width="2"/>
        <circle cx="100" cy="240" r="2" fill="#EC2D68"/>
      </g>
      <g transform="translate(110, 245)">
        <rect x="0" y="0" width="78" height="20" rx="10" fill="#FFE4E6" stroke="#EC2D68" stroke-width="1.2"/>
        <text x="39" y="14" font-size="9" font-weight="800" fill="#9F1239"
              text-anchor="middle" letter-spacing="1.5">INEFFICIENT</text>
      </g>
  ...
  supplyMovementVsShift: `
    <svg viewBox="0 0 1080 420" width="100%" height="auto" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" font-family="Inter, sans-serif">
      <rect width="1080" height="420" fill="#FFFFFF"/>

      <!-- ===== LEFT: Movement along ===== -->
      <g transform="translate(20,20)">
        <text x="260" y="32" font-size="20" font-weight="800" fill="#10B981" text-anchor="middle">Movement along the supply curve</text>

        <g transform="translate(60,55)">
          <line x1="40" y1="240" x2="430" y2="240" stroke="#0F172A" stroke-width="2"/>
          <polygon points="430,234 430,246 442,240" fill="#0F172A"/>
          <line x1="40" y1="240" x2="40" y2="20" stroke="#0F172A" stroke-width="2"/>
          <polygon points="34,20 46,20 40,8" fill="#0F172A"/>

          <text x="18" y="26" font-size="20" font-style="italic" font-weight="700" fill="#0F172A">P</text>
          <text x="450" y="246" font-size="20" font-style="italic" font-weight="700" fill="#0F172A">Q</text>

          <text x="32" y="186" font-size="17" font-style="italic" font-weight="700" fill="#0F172A" text-anchor="end">P<tspan font-size="11" baseline-shift="sub" dx="-1">1</tspan></text>
          <text x="32" y="104" font-size="17" font-style="italic" font-weight="700" fill="#0F172A" text-anchor="end">P<tspan font-size="11" baseline-shift="sub" dx="-1">2</tspan></text>
          <text x="150" y="262" font-size="17" font-style="italic" font-weight="700" fill="#0F172A" text-anchor="middle">Q<tspan font-size="11" baseline-shift="sub" dx="-1">1</tspan></text>
          <text x="240" y="262" font-size="17" font-style="italic" font-weight="700" fill="#0F172A" text-anchor="middle">Q<tspan font-size="11" baseline-shift="sub" dx="-1">2</tspan></text>
          ...
          <g stroke="#CBD5E1" stroke-width="1.5" stroke-dasharray="4 3">
            ...
            <line x1="240" y1="100" x2="240" y2="240"/>
          </g>

          <line x1="60" y1="220" x2="380" y2="30" stroke="#10B981" stroke-width="3" stroke-linecap="round"/>
          <text x="388" y="34" font-size="22" font-style="italic" font-weight="800" fill="#10B981">S</text>

          <circle cx="150" cy="180" r="6" fill="#0F172A"/>
          <circle cx="240" cy="100" r="6" fill="#0F172A"/>

          <!-- curved arrow from E1 to E2 along the curve -->
          <path d="M 165 170 Q 192 142 228 110" stroke="#10B981" stroke-width="2.5" fill="none" stroke-linecap="round"/>
          <polygon points="223,107 232,113 235,103" fill="#10B981"/>
        </g>

        <!-- cause pill -->
        <rect x="60" y="340" width="440" height="44" rx="10" fill="#ECFDF5" stroke="#A7F3D0"/>
        <text x="80" y="368" font-size="15" font-weight="800" fill="#059669">Cause:</text>
        <text x="138" y="368" font-size="15" fill="#065F46">change in the good's own price</text>
      </g>

      <!-- ===== RIGHT: Shift ===== -->
      <g transform="translate(560,20)">
        <text x="260" y="32" font-size="20" font-weight="800" fill="#D97706" text-anchor="middle">Shift of the supply curve</text>
        ...
        <g transform="translate(60,55)">
          ...
          <!-- S1 (decrease - on left, orange) -->
          <line x1="80" y1="220" x2="270" y2="30" stroke="#F59E0B" stroke-width="3" stroke-linecap="round"/>
          <text x="270" y="24" font-size="18" font-style="italic" font-weight="800" fill="#F59E0B">S<tspan font-size="11" baseline-shift="sub" dx="-1">1</tspan></text>

          <!-- S0 (baseline, gray dashed) -->
          <line x1="140" y1="220" x2="330" y2="30" stroke="#94A3B8" stroke-width="2" stroke-dasharray="6 4" stroke-linecap="round"/>

          <!-- S2 (increase - on right, green) -->
          <line x1="200" y1="220" x2="395" y2="30" stroke="#10B981" stroke-width="3" stroke-linecap="round"/>
          <text x="395" y="24" font-size="18" font-style="italic" font-weight="800" fill="#10B981">S<tspan font-size="11" baseline-shift="sub" dx="-1">2</tspan></text>

          <!-- decrease arrow (leftward, orange) -->
          <text x="78" y="116" font-size="13" font-weight="700" fill="#D97706" text-anchor="middle">decrease</text>
          <text x="78" y="132" font-size="13" font-weight="700" fill="#D97706" text-anchor="middle">in supply</text>
          <line x1="145" y1="155" x2="80" y2="155" stroke="#F59E0B" stroke-width="2.5"/>
          <polygon points="80,150 80,160 70,155" fill="#F59E0B"/>

          <!-- increase arrow (rightward, green) -->
          <text x="365" y="170" font-size="13" font-weight="700" fill="#10B981" text-anchor="middle">increase</text>
          <text x="365" y="186" font-size="13" font-weight="700" fill="#10B981" text-anchor="middle">in supply</text>
          <line x1="265" y1="155" x2="335" y2="155" stroke="#10B981" stroke-width="2.5"/>
          <polygon points="335,150 335,160 345,155" fill="#10B981"/>
        </g>

        <rect x="60" y="340" width="440" height="44" rx="10" fill="#FFFBEB" stroke="#FDE68A"/>
        <text x="80" y="368" font-size="15" font-weight="800" fill="#D97706">Cause:</text>
        <text x="138" y="368" font-size="15" fill="#92400E">non-price determinant</text>
      </g>
    </svg>
  `,

  supplyShiftDualMini: `
    <svg viewBox="0 0 1040 280" width="100%" height="auto" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" font-family="Inter, sans-serif">
      <rect width="1040" height="280" fill="#FFFFFF"/>

      <!-- LEFT: right shift -->
      <g transform="translate(20,20)">
        <text x="240" y="22" font-size="16" font-weight="800" fill="#10B981" text-anchor="middle">Supply increases (right shift)</text>

        <g transform="translate(40,40)">
          <line x1="40" y1="180" x2="400" y2="180" stroke="#0F172A" stroke-width="2"/>
          <polygon points="400,174 400,186 410,180" fill="#0F172A"/>
          <line x1="40" y1="180" x2="40" y2="20" stroke="#0F172A" stroke-width="2"/>
          <polygon points="34,20 46,20 40,10" fill="#0F172A"/>

          <text x="22" y="22" font-size="16" font-style="italic" font-weight="700" fill="#0F172A">P</text>
          <text x="418" y="186" font-size="16" font-style="italic" font-weight="700" fill="#0F172A">Q</text>

          <line x1="80" y1="160" x2="240" y2="30" stroke="#94A3B8" stroke-width="2.5" stroke-linecap="round"/>
          <text x="246" y="30" font-size="16" font-style="italic" font-weight="800" fill="#475569">S<tspan font-size="10" baseline-shift="sub" dx="-1">1</tspan></text>

          <line x1="160" y1="160" x2="330" y2="30" stroke="#10B981" stroke-width="3" stroke-linecap="round"/>
          <text x="336" y="30" font-size="16" font-style="italic" font-weight="800" fill="#10B981">S<tspan font-size="10" baseline-shift="sub" dx="-1">2</tspan></text>

          <line x1="155" y1="115" x2="245" y2="115" stroke="#10B981" stroke-width="3"/>
          <polygon points="245,108 245,122 259,115" fill="#10B981"/>
        </g>
      </g>

      <!-- RIGHT: left shift -->
      <g transform="translate(540,20)">
        <text x="240" y="22" font-size="16" font-weight="800" fill="#8B5CF6" text-anchor="middle">Supply decreases (left shift)</text>
        ...
        <g transform="translate(40,40)">
          ...
          <line x1="160" y1="160" x2="330" y2="30" stroke="#94A3B8" stroke-width="2.5" stroke-linecap="round"/>
          <text x="336" y="30" font-size="16" font-style="italic" font-weight="800" fill="#475569">S<tspan font-size="10" baseline-shift="sub" dx="-1">1</tspan></text>

          <line x1="80" y1="160" x2="240" y2="30" stroke="#8B5CF6" stroke-width="3" stroke-linecap="round"/>
          <text x="246" y="30" font-size="16" font-style="italic" font-weight="800" fill="#8B5CF6">S<tspan font-size="10" baseline-shift="sub" dx="-1">2</tspan></text>

          <line x1="245" y1="115" x2="155" y2="115" stroke="#8B5CF6" stroke-width="3"/>
          <polygon points="155,108 155,122 141,115" fill="#8B5CF6"/>
        </g>
      </g>
    </svg>
  `,
  ...
  producerSurplus: `
    <svg viewBox="0 0 1040 440" width="100%" height="auto" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" font-family="Inter, sans-serif">
      ...
      <g transform="translate(40,20)">
        ...
        <text x="70" y="188" font-size="22" font-style="italic" font-weight="700" fill="#0F172A" text-anchor="end">P<tspan font-size="15" baseline-shift="sub" dx="-1">E</tspan></text>
        <text x="296" y="410" font-size="22" font-style="italic" font-weight="700" fill="#0F172A" text-anchor="middle">Q<tspan font-size="15" baseline-shift="sub" dx="-1">E</tspan></text>
        <text x="72" y="402" font-size="20" font-weight="700" fill="#0F172A" text-anchor="end">0</text>

        <!-- shaded producer surplus triangle -->
        <polygon points="80,182 296,182 80,360" fill="#10B981" fill-opacity="0.18" stroke="#10B981" stroke-width="1.5"/>

        <!-- dashed projection lines -->
        <g stroke="#CBD5E1" stroke-width="1.5" stroke-dasharray="5 4">
          <line x1="80" y1="182" x2="296" y2="182"/>
          <line x1="296" y1="182" x2="296" y2="380"/>
        </g>

        <!-- supply curve -->
        <line x1="100" y1="360" x2="430" y2="60" stroke="#10B981" stroke-width="3" stroke-linecap="round"/>
        <text x="438" y="58" font-size="26" font-style="italic" font-weight="800" fill="#10B981">S</text>

        <!-- equilibrium dot -->
        <circle cx="296" cy="182" r="7" fill="#0F172A"/>

        <!-- 'Producer surplus' label inside the triangle -->
        <text x="148" y="278" font-size="15" font-weight="800" fill="#059669" text-anchor="middle">Producer</text>
        <text x="148" y="298" font-size="15" font-weight="800" fill="#059669" text-anchor="middle">surplus</text>
      </g>
      ...
      <g transform="translate(560,30)">
        <circle cx="22" cy="30" r="18" fill="none" stroke="#10B981" stroke-width="2.5"/>
        <text x="22" y="37" text-anchor="middle" font-size="18" font-weight="800" fill="#10B981">1</text>
        <text x="56" y="36" font-size="20" font-weight="800" fill="#0F172A">What it is</text>
        <text x="56" y="64" font-size="17" fill="#334155">Producer surplus is the difference</text>
        <text x="56" y="86" font-size="17" fill="#334155">between the market price firms receive</text>
        <text x="56" y="108" font-size="17" fill="#334155">and the minimum price they would have</text>
        <text x="56" y="130" font-size="17" fill="#334155">been willing to accept.</text>

        <circle cx="22" cy="172" r="18" fill="none" stroke="#10B981" stroke-width="2.5"/>
        <text x="22" y="179" text-anchor="middle" font-size="18" font-weight="800" fill="#10B981">2</text>
        <text x="56" y="178" font-size="20" font-weight="800" fill="#0F172A">Why it exists</text>
        <text x="56" y="206" font-size="17" fill="#334155">Firms with lower costs are willing to</text>
        <text x="56" y="228" font-size="17" fill="#334155">supply at prices below the market</text>
        <text x="56" y="250" font-size="17" fill="#334155">price, so they gain surplus.</text>

        <circle cx="22" cy="292" r="18" fill="none" stroke="#10B981" stroke-width="2.5"/>
        <text x="22" y="299" text-anchor="middle" font-size="18" font-weight="800" fill="#10B981">3</text>
        <text x="56" y="298" font-size="20" font-weight="800" fill="#0F172A">What changes it</text>
        <text x="56" y="326" font-size="17" fill="#334155">Higher price or lower costs increase</text>
        <text x="56" y="348" font-size="17" fill="#334155">surplus; lower price reduces it.</text>
      </g>
    </svg>
  `,

  jointVsCompetingSupply: `
    <svg viewBox="0 0 1080 480" width="100%" height="auto" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" font-family="Inter, sans-serif">
      <rect width="1080" height="480" fill="#FFFFFF"/>

      <!-- ===== LEFT: Joint supply ===== -->
      <g transform="translate(20,20)">
        <text x="260" y="32" font-size="22" font-weight="800" fill="#0F172A" text-anchor="middle">Joint supply</text>
        <text x="260" y="58" font-size="14" fill="#475569" text-anchor="middle">Products are produced together.</text>

        <!-- Row 1: Cattle → Beef + Leather -->
        <g transform="translate(40,90)">
          <circle cx="40" cy="40" r="36" fill="#ECFDF5" stroke="#10B981" stroke-width="2.5"/>
          <text x="40" y="54" text-anchor="middle" font-size="36" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">🐄</text>
          <text x="40" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#0F172A">Cattle</text>

          <line x1="85" y1="40" x2="155" y2="40" stroke="#475569" stroke-width="2"/>
          <polygon points="155,34 155,46 165,40" fill="#475569"/>

          <rect x="175" y="10" width="110" height="60" rx="10" fill="#FEF2F2" stroke="#FECACA"/>
          <text x="200" y="50" font-size="26" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">🥩</text>
          <text x="248" y="48" font-size="14" font-weight="700" fill="#0F172A">Beef</text>

          <text x="300" y="48" font-size="22" font-weight="800" fill="#475569">+</text>

          <rect x="320" y="10" width="130" height="60" rx="10" fill="#FFFBEB" stroke="#FDE68A"/>
          <text x="345" y="50" font-size="26" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">👜</text>
          <text x="385" y="48" font-size="14" font-weight="700" fill="#0F172A">Leather</text>
        </g>

        <!-- Row 2: Crude oil → Petrol + Diesel -->
        <g transform="translate(40,210)">
          <circle cx="40" cy="40" r="36" fill="#ECFDF5" stroke="#10B981" stroke-width="2.5"/>
          <text x="40" y="54" text-anchor="middle" font-size="34" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">🛢️</text>
          <text x="40" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#0F172A">Crude oil</text>

          <line x1="85" y1="40" x2="155" y2="40" stroke="#475569" stroke-width="2"/>
          <polygon points="155,34 155,46 165,40" fill="#475569"/>

          <rect x="175" y="10" width="110" height="60" rx="10" fill="#FFFBEB" stroke="#FDE68A"/>
          <text x="200" y="50" font-size="26" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">⛽</text>
          <text x="248" y="48" font-size="14" font-weight="700" fill="#0F172A">Petrol</text>

          <text x="300" y="48" font-size="22" font-weight="800" fill="#475569">+</text>

          <rect x="320" y="10" width="130" height="60" rx="10" fill="#EFF6FF" stroke="#BFDBFE"/>
          <text x="345" y="50" font-size="26" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">💧</text>
          <text x="385" y="48" font-size="14" font-weight="700" fill="#0F172A">Diesel</text>
        </g>

        <!-- Bullets -->
        <g transform="translate(40,360)" font-size="13.5" fill="#0F172A">
          <circle cx="6" cy="-4" r="3" fill="#10B981"/>
          <text x="18" y="0">Two or more products are created in the same production process.</text>
          <circle cx="6" cy="22" r="3" fill="#10B981"/>
          <text x="18" y="26">You cannot get more of one without also getting more of the other.</text>
          <circle cx="6" cy="48" r="3" fill="#10B981"/>
          <text x="18" y="52">When output of one rises, the supply of the joint product also rises.</text>
        </g>
      </g>

      <!-- ===== RIGHT: Competing supply ===== -->
      <g transform="translate(560,20)">
        <text x="260" y="32" font-size="22" font-weight="800" fill="#0F172A" text-anchor="middle">Competing supply</text>
        <text x="260" y="58" font-size="14" fill="#475569" text-anchor="middle">Products compete for the same scarce resources.</text>

        <!-- Row 1: Farmland → Wheat or Rapeseed -->
        <g transform="translate(40,90)">
          <circle cx="40" cy="40" r="36" fill="#F5F3FF" stroke="#8B5CF6" stroke-width="2.5"/>
          <text x="40" y="54" text-anchor="middle" font-size="34" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">🌳</text>
          <text x="40" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#0F172A">Farmland</text>
          ...
          <rect x="175" y="10" width="110" height="60" rx="10" fill="#FFFBEB" stroke="#FDE68A"/>
          <text x="200" y="50" font-size="26" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">🌾</text>
          <text x="248" y="48" font-size="14" font-weight="700" fill="#0F172A">Wheat</text>

          <text x="298" y="48" font-size="14" font-weight="700" fill="#475569">or</text>

          <rect x="330" y="10" width="130" height="60" rx="10" fill="#FFFBEB" stroke="#FDE68A"/>
          <text x="355" y="50" font-size="26" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">🌻</text>
          <text x="395" y="48" font-size="14" font-weight="700" fill="#0F172A">Rapeseed</text>
        </g>

        <!-- Row 2: Factory → Cars or Vans -->
        <g transform="translate(40,210)">
          <circle cx="40" cy="40" r="36" fill="#F5F3FF" stroke="#8B5CF6" stroke-width="2.5"/>
          <text x="40" y="54" text-anchor="middle" font-size="32" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">🏭</text>
          <text x="40" y="100" text-anchor="middle" font-size="11.5" font-weight="700" fill="#0F172A">Factory capacity</text>

          <line x1="85" y1="40" x2="155" y2="40" stroke="#475569" stroke-width="2"/>
          <polygon points="155,34 155,46 165,40" fill="#475569"/>

          <rect x="175" y="10" width="110" height="60" rx="10" fill="#EFF6FF" stroke="#BFDBFE"/>
          <text x="200" y="50" font-size="26" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">🚗</text>
          <text x="248" y="48" font-size="14" font-weight="700" fill="#0F172A">Cars</text>

          <text x="298" y="48" font-size="14" font-weight="700" fill="#475569">or</text>

          <rect x="330" y="10" width="130" height="60" rx="10" fill="#ECFDF5" stroke="#A7F3D0"/>
          <text x="355" y="50" font-size="26" font-family="'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji',sans-serif">🚐</text>
          <text x="395" y="48" font-size="14" font-weight="700" fill="#0F172A">Vans</text>
        </g>

        <!-- Bullets -->
        <g transform="translate(40,360)" font-size="13.5" fill="#0F172A">
          <circle cx="6" cy="-4" r="3" fill="#8B5CF6"/>
          <text x="18" y="0">Resources have alternative uses in different products.</text>
          <circle cx="6" cy="22" r="3" fill="#8B5CF6"/>
          <text x="18" y="26">Using more resources for one product means less for another.</text>
          <circle cx="6" cy="48" r="3" fill="#8B5CF6"/>
          <text x="18" y="52">More resources for one product can reduce supply of the other.</text>
        </g>
      </g>
    </svg>
  `,
