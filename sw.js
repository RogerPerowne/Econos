...
(function () {
  ...
  const PRECACHE_ASSETS = [
    ...
    '/js/charts/specs/tariff-diagram-interactive.js',
    ...
    '/js/charts/specs/lorenz-curve.js',
    '/js/charts/specs/lorenz-compare.js',
    '/js/charts/specs/gini-areas.js',
    '/js/charts/specs/buffer-stock-bands.js',
    '/js/charts/specs/bubble-cycle.js',
    '/js/charts/specs/kuznets-curve.js',
    '/js/charts/specs/output-gap-compare.js',
    '/js/charts/specs/output-gap-sign.js',
    '/js/charts/specs/output-gap-recess-ck.js',
    '/js/charts/specs/output-gap-inflat-ck.js',
    '/js/charts/specs/marcos-cost-curves.js',
    '/js/charts/specs/marcos-profit-max.js',
    '/js/charts/specs/marcos-profit-max-pc.js',
    '/js/charts/specs/total-cost.js',
    '/js/charts/specs/average-cost-family.js',
    '/js/charts/specs/marginal-cost.js',
    '/js/charts/specs/full-cost-diagram.js',
    '/js/charts/specs/monopoly-profit-max.js',
    '/js/charts/specs/monopoly-welfare.js',
    '/js/charts/specs/price-discrimination.js',
    '/js/charts/specs/labour-demand-curve.js',
    ...
    '/js/charts/specs/mc-demand-comparison.js',
    '/js/charts/specs/pc-efficiency.js',
    '/js/charts/specs/natural-monopoly.js',
    '/js/charts/specs/kinked-demand.js',
    '/js/charts/specs/lrac-big-picture.js',
    '/js/charts/specs/mes-chart.js',
    '/js/charts/specs/productive-efficiency.js',
    '/js/charts/specs/toe-allocative.js',
    '/js/charts/specs/dynamic-efficiency.js',
